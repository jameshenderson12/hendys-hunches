...
<html lang="en" class="h-100">
  ...
  <body class="d-flex h-100 text-center text-bg-dark">
      ...
      <form class="row g-3 needs-validation border border-white p-2 my-2 border-opacity-25" novalidate> <!-- id="registrationForm" name="registrationForm" class="form-horizontal" method="post" action="php/register.php" onSubmit="return validateFullForm()" -->
        <div class="col-md-6">
