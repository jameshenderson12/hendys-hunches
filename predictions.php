                ...
                $(document).ready(function () {
                    ...
                    $.getJSON("json/fifa-world-cup-2022-fixtures-groups.json",
                        ...
                        $.each(data, function (key, value) {
														...
														const date = new Date(+year, +month - 1, +day, +hours, +minutes).toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'});
														console.log(date);
                            fixture += '<tr>';
                            ...
                            fixture += '<td class="small text-muted"> ' + date + '<br>' + value.Location + '</td>';
                            fixture += '</tr>';
														x+=2;
														y+=2;
                        });
