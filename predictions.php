...
<html lang="en">
  ...
  <body>
	...
	<div id="main-section" class="col-md-10 col-md-offset-1">
      ...
      <p>To make your predictions, enter a score value into each box below. You can change score values for a game up until 2 hours before its kick-off. Remember to hit the 'Update my predictions' button to save your scores.</p>
      <p><!--<span class="label label-danger">Important</span>--><strong>The default value for any unentered predictions is a no score draw (0-0).</strong></p>
      ...
      <div class="row">
        ...
        <img src="<?php echo $A2img; ?>" alt="<?php echo $A2; ?>" title="<?php echo $A2; ?>"><label for="score2_p"><?php abbrTeam($A2); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_10Jun, $venue1"; ?></td>
      	</tr>
        ...
        <img src="<?php echo $A4img; ?>" alt="<?php echo $A4; ?>" title="<?php echo $A4; ?>"><label for="score4_p"><?php abbrTeam($A4); ?></label></td>
      	<td class="date-venue"><?php echo "$_2pm, $_11Jun, $venue11"; ?></td>
      	</tr>

      	<tr>
        <td class="date-venue">Match 3<br>Group B</td>        
      	<td class="left-team">
        <img src="<?php echo $B1img; ?>" alt="<?php echo $B1; ?>" title="<?php echo $B1; ?>"><label for="score5_p"><?php abbrTeam($B1); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $B2img; ?>" alt="<?php echo $B2; ?>" title="<?php echo $B2; ?>"><label for="score6_p"><?php abbrTeam($B2); ?></label></td>
      	<td class="date-venue"><?php echo "$_5pm, $_11Jun, $venue12"; ?></td>    
      	</tr>
        
      	<tr>
        <td class="date-venue">Match 4<br>Group B</td>        
      	<td class="left-team">
        <img src="<?php echo $B3img; ?>" alt="<?php echo $B3; ?>" title="<?php echo $B3; ?>"><label for="score7_p"><?php abbrTeam($B3); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $B4img; ?>" alt="<?php echo $B4; ?>" title="<?php echo $B4; ?>"><label for="score8_p"><?php abbrTeam($B4); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_11Jun, $venue4"; ?></td>
      	</tr>
                        
      	<tr>        
        <td class="date-venue">Match 5<br>Group D</td>        
	    <td class="left-team">
        <img src="<?php echo $D1img; ?>" alt="<?php echo $D1; ?>" title="<?php echo $D1; ?>"><label for="score9_p"><?php abbrTeam($D1); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $D2img; ?>" alt="<?php echo $D2; ?>" title="<?php echo $D2; ?>"><label for="score10_p"><?php abbrTeam($D2); ?></label></td>
      	<td class="date-venue"><?php echo "$_2pm, $_12Jun, $venue3"; ?></td>
      	</tr>

      	<tr>        
        <td class="date-venue">Match 6<br>Group C</td>        
      	<td class="left-team">
        <img src="<?php echo $C1img; ?>" alt="<?php echo $C1; ?>" title="<?php echo $C1; ?>"><label for="score11_p"><?php abbrTeam($C1); ?></label></td>
      	...
      	<td class="right-team">
		<img src="<?php echo $C2img; ?>" alt="<?php echo $C2; ?>" title="<?php echo $C2; ?>"><label for="score12_p"><?php abbrTeam($C2); ?></label></td>
        <td class="date-venue"><?php echo "$_5pm, $_12Jun, $venue10"; ?></td>
      	</tr>
        ...
        <img src="<?php echo $C4img; ?>" alt="<?php echo $C4; ?>" title="<?php echo $C4; ?>"><label for="score14_p"><?php abbrTeam($C4); ?></label></td>       
      	<td class="date-venue"><?php echo "$_8pm, $_12Jun, $venue6"; ?></td>
      	</tr>
        ...
        <img src="<?php echo $D4img; ?>" alt="<?php echo $D4; ?>" title="<?php echo $D4; ?>"><label for="score16_p"><?php abbrTeam($D4); ?></label></td>
      	<td class="date-venue"><?php echo "$_2pm, $_13Jun, $venue8"; ?></td>
      	</tr>
        
      	<tr>     
        <td class="date-venue">Match 9<br>Group E</td>           
	    <td class="left-team">
        <img src="<?php echo $E1img; ?>" alt="<?php echo $E1; ?>" title="<?php echo $E1; ?>"><label for="score17_p"><?php abbrTeam($E1); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $E2img; ?>" alt="<?php echo $E2; ?>" title="<?php echo $E2; ?>"><label for="score18_p"><?php abbrTeam($E2); ?></label></td>
      	<td class="date-venue"><?php echo "$_5pm, $_13Jun, $venue1"; ?></td>
      	</tr>
        
      	<tr>
        <td class="date-venue">Match 10<br>Group E</td>        
      	<td class="left-team">
        <img src="<?php echo $E3img; ?>" alt="<?php echo $E3; ?>" title="<?php echo $E3; ?>"><label for="score19_p"><?php abbrTeam($E3); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $E4img; ?>" alt="<?php echo $E4; ?>" title="<?php echo $E4; ?>"><label for="score20_p"><?php abbrTeam($E4); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_13Jun, $venue14"; ?></td>
      	</tr>
        
        <tr>
        <td class="date-venue">Match 11<br>Group F</td>        
      	<td class="left-team">
        <img src="<?php echo $F1img; ?>" alt="<?php echo $F1; ?>" title="<?php echo $F1; ?>"><label for="score21_p"><?php abbrTeam($F1); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $F2img; ?>" alt="<?php echo $F2; ?>" title="<?php echo $F2; ?>"><label for="score22_p"><?php abbrTeam($F2); ?></label></td>
      	<td class="date-venue"><?php echo "$_5pm, $_14Jun, $venue12"; ?></td>
      	</tr>
        ...
        <img src="<?php echo $F4img; ?>" alt="<?php echo $F4; ?>" title="<?php echo $F4; ?>"><label for="score24_p"><?php abbrTeam($F4); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_14Jun, $venue9"; ?></td>
      	</tr>

      	<tr>          
        <td class="date-venue">Match 13<br>Group B</td>        
	    <td class="left-team">
        <img src="<?php echo $B4img; ?>" alt="<?php echo $B4; ?>" title="<?php echo $B4; ?>"><label for="score25_p"><?php abbrTeam($B4); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $B2img; ?>" alt="<?php echo $B2; ?>" title="<?php echo $B2; ?>"><label for="score26_p"><?php abbrTeam($B2); ?></label></td>
      	<td class="date-venue"><?php echo "$_2pm, $_15Jun, $venue6"; ?></td>
      	</tr>
        
      	<tr>
        <td class="date-venue">Match 14<br>Group A</td>        
      	<td class="left-team">
        <img src="<?php echo $A2img; ?>" alt="<?php echo $A2; ?>" title="<?php echo $A2; ?>"><label for="score27_p"><?php abbrTeam($A2); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $A4img; ?>" alt="<?php echo $A4; ?>" title="<?php echo $A4; ?>"><label for="score28_p"><?php abbrTeam($A4); ?></label></td>
      	<td class="date-venue"><?php echo "$_5pm, $_15Jun, $venue3"; ?></td>
      	</tr>
        
        <tr>
        <td class="date-venue">Match 15<br>Group A</td>        
      	<td class="left-team">
        <img src="<?php echo $A1img; ?>" alt="<?php echo $A1; ?>" title="<?php echo $A1; ?>"><label for="score29_p"><?php abbrTeam($A1); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $A3img; ?>" alt="<?php echo $A3; ?>" title="<?php echo $A3; ?>"><label for="score30_p"><?php abbrTeam($A3); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_15Jun, $venue4"; ?></td>
        </tr>
      	
        <tr>
        <td class="date-venue">Match 16<br>Group B</td>        
      	<td class="left-team">
        <img src="<?php echo $B3img; ?>" alt="<?php echo $B3; ?>" title="<?php echo $B3; ?>"><label for="score31_p"><?php abbrTeam($B3); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $B1img; ?>" alt="<?php echo $B1; ?>" title="<?php echo $B1; ?>"><label for="score32_p"><?php abbrTeam($B1); ?></label></td>
      	<td class="date-venue"><?php echo "$_2pm, $_16Jun, $venue11"; ?></td>
      	</tr>

      	<tr>        
        <td class="date-venue">Match 17<br>Group C</td>        
	    <td class="left-team">
        <img src="<?php echo $C4img; ?>" alt="<?php echo $C4; ?>" title="<?php echo $C4; ?>"><label for="score33_p"><?php abbrTeam($C4); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $C2img; ?>" alt="<?php echo $C2; ?>" title="<?php echo $C2; ?>"><label for="score34_p"><?php abbrTeam($C2); ?></label></td>
      	<td class="date-venue"><?php echo "$_5pm, $_16Jun, $venue14"; ?></td>
      	</tr>

      	<tr>
        <td class="date-venue">Match 18<br>Group C</td>        
      	<td class="left-team">
        <img src="<?php echo $C3img; ?>" alt="<?php echo $C3; ?>" title="<?php echo $C3; ?>"><label for="score35_p"><?php abbrTeam($C3); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $C1img; ?>" alt="<?php echo $C1; ?>" title="<?php echo $C1; ?>"><label for="score36_p"><?php abbrTeam($C1); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_16Jun, $venue1"; ?></td>
      	</tr>

        <tr>
        <td class="date-venue">Match 19<br>Group E</td>        
      	<td class="left-team">
        <img src="<?php echo $E4img; ?>" alt="<?php echo $E4; ?>" title="<?php echo $E4; ?>"><label for="score37_p"><?php abbrTeam($E4); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $E2img; ?>" alt="<?php echo $E2; ?>" title="<?php echo $E2; ?>"><label for="score38_p"><?php abbrTeam($E2); ?></label></td>
      	<td class="date-venue"><?php echo "$_2pm, $_17Jun, $venue8"; ?></td>
      	</tr>

      	<tr>
        <td class="date-venue">Match 20<br>Group D</td>        
      	<td class="left-team">
        <img src="<?php echo $D4img; ?>" alt="<?php echo $D4; ?>" title="<?php echo $D4; ?>"><label for="score39_p"><?php abbrTeam($D4); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $D2img; ?>" alt="<?php echo $D2; ?>" title="<?php echo $D2; ?>"><label for="score40_p"><?php abbrTeam($D2); ?></label></td>
      	<td class="date-venue"><?php echo "$_5pm, $_17Jun, $venue9"; ?></td>
      	</tr>

      	<tr>
        <td class="date-venue">Match 21<br>Group D</td>        
      	<td class="left-team">
        <img src="<?php echo $D3img; ?>" alt="<?php echo $D3; ?>" title="<?php echo $D3; ?>"><label for="score41_p"><?php abbrTeam($D3); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $D1img; ?>" alt="<?php echo $D1; ?>" title="<?php echo $D1; ?>"><label for="score42_p"><?php abbrTeam($D1); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_17Jun, $venue10"; ?></td>
      	</tr>

      	<tr>
        <td class="date-venue">Match 22<br>Group E</td>        
      	<td class="left-team">
        <img src="<?php echo $E3img; ?>" alt="<?php echo $E3; ?>" title="<?php echo $E3; ?>"><label for="score43_p"><?php abbrTeam($E3); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $E1img; ?>" alt="<?php echo $E1; ?>" title="<?php echo $E1; ?>"><label for="score44_p"><?php abbrTeam($E1); ?></label></td>
      	<td class="date-venue"><?php echo "$_2pm, $_18Jun, $venue12"; ?></td>
      	</tr>

      	<tr>        
        <td class="date-venue">Match 23<br>Group F</td>        
	    <td class="left-team">
        <img src="<?php echo $F4img; ?>" alt="<?php echo $F4; ?>" title="<?php echo $F4; ?>"><label for="score45_p"><?php abbrTeam($F4); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $F2img; ?>" alt="<?php echo $F2; ?>" title="<?php echo $F2; ?>"><label for="score46_p"><?php abbrTeam($F2); ?></label></td>
      	<td class="date-venue"><?php echo "$_5pm, $_18Jun, $venue4"; ?></td>
      	</tr>

      	<tr>
        <td class="date-venue">Match 24<br>Group F</td>        
      	<td class="left-team">
        <img src="<?php echo $F3img; ?>" alt="<?php echo $F3; ?>" title="<?php echo $F3; ?>"><label for="score47_p"><?php abbrTeam($F3); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $F1img; ?>" alt="<?php echo $F1; ?>" title="<?php echo $F1; ?>"><label for="score48_p"><?php abbrTeam($F1); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_18Jun, $venue3"; ?></td>
      	</tr>

        <tr>
        <td class="date-venue">Match 25<br>Group A</td>        
      	<td class="left-team">
        <img src="<?php echo $A4img; ?>" alt="<?php echo $A4; ?>" title="<?php echo $A4; ?>"><label for="score49_p"><?php abbrTeam($A4); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $A1img; ?>" alt="<?php echo $A1; ?>" title="<?php echo $A1; ?>"><label for="score50_p"><?php abbrTeam($A1); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_19Jun, $venue6"; ?></td>
      	</tr>

      	<tr>        
        <td class="date-venue">Match 26<br>Group A</td>        
      	<td class="left-team">
        <img src="<?php echo $A2img; ?>" alt="<?php echo $A2; ?>" title="<?php echo $A2; ?>"><label for="score51_p"><?php abbrTeam($A2); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $A3img; ?>" alt="<?php echo $A3; ?>" title="<?php echo $A3; ?>"><label for="score52_p"><?php abbrTeam($A3); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_19Jun, $venue14"; ?></td>
      	</tr>

      	<tr>        
        <td class="date-venue">Match 27<br>Group B</td>        
	    <td class="left-team">
        <img src="<?php echo $B2img; ?>" alt="<?php echo $B2; ?>" title="<?php echo $B2; ?>"><label for="score53_p"><?php abbrTeam($B2); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $B3img; ?>" alt="<?php echo $B3; ?>" title="<?php echo $B3; ?>"><label for="score54_p"><?php abbrTeam($B3); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_20Jun, $venue9"; ?></td>
      	</tr>

      	<tr>
        <td class="date-venue">Match 28<br>Group B</td>        
      	<td class="left-team">
        <img src="<?php echo $B4img; ?>" alt="<?php echo $B4; ?>" title="<?php echo $B4; ?>"><label for="score55_p"><?php abbrTeam($B4); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $B1img; ?>" alt="<?php echo $B1; ?>" title="<?php echo $B1; ?>"><label for="score56_p"><?php abbrTeam($B1); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_20Jun, $venue8"; ?></td>
      	</tr>

        <tr>
        <td class="date-venue">Match 29<br>Group C</td>        
      	<td class="left-team">
        <img src="<?php echo $C2img; ?>" alt="<?php echo $C2; ?>" title="<?php echo $C2; ?>"><label for="score57_p"><?php abbrTeam($C2); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $C3img; ?>" alt="<?php echo $C3; ?>" title="<?php echo $C3; ?>"><label for="score58_p"><?php abbrTeam($C3); ?></label></td>
      	<td class="date-venue"><?php echo "$_5pm, $_21Jun, $venue3"; ?></td>
      	</tr>

      	<tr>
        <td class="date-venue">Match 30<br>Group C</td>        
      	<td class="left-team">
        <img src="<?php echo $C4img; ?>" alt="<?php echo $C4; ?>" title="<?php echo $C4; ?>"><label for="score59_p"><?php abbrTeam($C4); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $C1img; ?>" alt="<?php echo $C1; ?>" title="<?php echo $C1; ?>"><label for="score60_p"><?php abbrTeam($C1); ?></label></td>
      	<td class="date-venue"><?php echo "$_5pm, $_21Jun, $venue4"; ?></td>
      	</tr>

        <tr>
        <td class="date-venue">Match 31<br>Group D</td>        
	    <td class="left-team">
        <img src="<?php echo $D2img; ?>" alt="<?php echo $D2; ?>" title="<?php echo $D2; ?>"><label for="score61_p"><?php abbrTeam($D2); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $D3img; ?>" alt="<?php echo $D3; ?>" title="<?php echo $D3; ?>"><label for="score62_p"><?php abbrTeam($D3); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_21Jun, $venue12"; ?></td>
      	</tr>

      	<tr>
        <td class="date-venue">Match 32<br>Group D</td>        
      	<td class="left-team">
        <img src="<?php echo $D4img; ?>" alt="<?php echo $D4; ?>" title="<?php echo $D4; ?>"><label for="score63_p"><?php abbrTeam($D4); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $D1img; ?>" alt="<?php echo $D1; ?>" title="<?php echo $D1; ?>"><label for="score64_p"><?php abbrTeam($D1); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_21Jun, $venue11"; ?></td>
      	</tr>

        <tr>        
        <td class="date-venue">Match 33<br>Group F</td>        
      	<td class="left-team">
        <img src="<?php echo $F4img; ?>" alt="<?php echo $F4; ?>" title="<?php echo $F4; ?>"><label for="score65_p"><?php abbrTeam($F4); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $F1img; ?>" alt="<?php echo $F1; ?>" title="<?php echo $F1; ?>"><label for="score66_p"><?php abbrTeam($F1); ?></label></td>
      	<td class="date-venue"><?php echo "$_5pm, $_22Jun, $venue1"; ?></td>
      	</tr>

      	<tr>
        <td class="date-venue">Match 34<br>Group F</td>        
      	<td class="left-team">
        <img src="<?php echo $F2img; ?>" alt="<?php echo $F2; ?>" title="<?php echo $F2; ?>"><label for="score67_p"><?php abbrTeam($F2); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $F3img; ?>" alt="<?php echo $F3; ?>" title="<?php echo $F3; ?>"><label for="score68_p"><?php abbrTeam($F3); ?></label></td>
      	<td class="date-venue"><?php echo "$_5pm, $_22Jun, $venue14"; ?></td>
      	</tr>

        <tr>
        <td class="date-venue">Match 35<br>Group E</td>        
	    <td class="left-team">
        <img src="<?php echo $E2img; ?>" alt="<?php echo $E2; ?>" title="<?php echo $E2; ?>"><label for="score69_p"><?php abbrTeam($E2); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $E3img; ?>" alt="<?php echo $E3; ?>" title="<?php echo $E3; ?>"><label for="score70_p"><?php abbrTeam($E3); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_22Jun, $venue10"; ?></td>
      	</tr>

      	<tr>
        <td class="date-venue">Match 36<br>Group E</td>        
      	<td class="left-team">
        <img src="<?php echo $E4img; ?>" alt="<?php echo $E4; ?>" title="<?php echo $E4; ?>"><label for="score71_p"><?php abbrTeam($E4); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $E1img; ?>" alt="<?php echo $E1; ?>" title="<?php echo $E1; ?>"><label for="score72_p"><?php abbrTeam($E1); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_22Jun, $venue6"; ?></td>
      	</tr>

		<!-- ROUND OF 16 ------------------------>
        <!--===================================-->
        <tr>
        <td class="date-venue">Match 37<br>RO16</td>        
      	<td class="left-team">
        <img src="<?php echo $R1img; ?>" alt="<?php echo $R1; ?>" title="<?php echo $R1; ?>"><label for="score73_p"><?php abbrTeam($R1); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $R2img; ?>" alt="<?php echo $R2; ?>" title="<?php echo $R2; ?>"><label for="score74_p"><?php abbrTeam($R2); ?></label></td>
      	<td class="date-venue"><?php echo "$_2pm, $_25Jun, $venue9"; ?></td>
      	</tr>

       	<tr>
        <td class="date-venue">Match 38<br>RO16</td>        
      	<td class="left-team">
        <img src="<?php echo $R3img; ?>" alt="<?php echo $R3; ?>" title="<?php echo $R3; ?>"><label for="score75_p"><?php abbrTeam($R3); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $R4img; ?>" alt="<?php echo $R4; ?>" title="<?php echo $R4; ?>"><label for="score76_p"><?php abbrTeam($R4); ?></label></td>
      	<td class="date-venue"><?php echo "$_5pm, $_25Jun, $venue3"; ?></td>
      	</tr>

        <tr>
        <td class="date-venue">Match 39<br>RO16</td>        
      	<td class="left-team">
        <img src="<?php echo $R5img; ?>" alt="<?php echo $R5; ?>" title="<?php echo $R5; ?>"><label for="score77_p"><?php abbrTeam($R5); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $R6img; ?>" alt="<?php echo $R6; ?>" title="<?php echo $R6; ?>"><label for="score78_p"><?php abbrTeam($R6); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_25Jun, $venue11"; ?></td>
      	</tr>
        
      	<tr>
        <td class="date-venue">Match 40<br>RO16</td>        
      	<td class="left-team">
        <img src="<?php echo $R7img; ?>" alt="<?php echo $R7; ?>" title="<?php echo $R7; ?>"><label for="score79_p"><?php abbrTeam($R7); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $R8img; ?>" alt="<?php echo $R8; ?>" title="<?php echo $R8; ?>"><label for="score80_p"><?php abbrTeam($R8); ?></label></td>
      	<td class="date-venue"><?php echo "$_2pm, $_26Jun, $venue14"; ?></td>
      	</tr>

        <tr>
        <td class="date-venue">Match 41<br>RO16</td>        
      	<td class="left-team">
        <img src="<?php echo $R9img; ?>" alt="<?php echo $R9; ?>" title="<?php echo $R9; ?>"><label for="score81_p"><?php abbrTeam($R9); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $R10img; ?>" alt="<?php echo $R10; ?>" title="<?php echo $R10; ?>"><label for="score82_p"><?php abbrTeam($R10); ?></label></td>
      	<td class="date-venue"><?php echo "$_5pm, $_26Jun, $venue6"; ?></td>
      	</tr>
        
      	<tr>
        <td class="date-venue">Match 42<br>RO16</td>        
      	<td class="left-team">
        <img src="<?php echo $R11img; ?>" alt="<?php echo $R11; ?>" title="<?php echo $R11; ?>"><label for="score83_p"><?php abbrTeam($R11); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $R12img; ?>" alt="<?php echo $R12; ?>" title="<?php echo $R12; ?>"><label for="score84_p"><?php abbrTeam($R12); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_26Jun, $venue8"; ?></td>
      	</tr>

        <tr>
        <td class="date-venue">Match 43<br>RO16</td>        
      	<td class="left-team">
        <img src="<?php echo $R13img; ?>" alt="<?php echo $R13; ?>" title="<?php echo $R13; ?>"><label for="score85_p"><?php abbrTeam($R13); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $R14img; ?>" alt="<?php echo $R14; ?>" title="<?php echo $R14; ?>"><label for="score86_p"><?php abbrTeam($R14); ?></label></td>
      	<td class="date-venue"><?php echo "$_5pm, $_27Jun, $venue1"; ?></td>
      	</tr>
        
      	<tr>
        <td class="date-venue">Match 44<br>RO16</td>        
      	<td class="left-team">
        <img src="<?php echo $R15img; ?>" alt="<?php echo $R15; ?>" title="<?php echo $R15; ?>"><label for="score87_p"><?php abbrTeam($R15); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $R16img; ?>" alt="<?php echo $R16; ?>" title="<?php echo $R16; ?>"><label for="score88_p"><?php abbrTeam($R16); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_27Jun, $venue10"; ?></td>
       	</tr>
        
		<!-- QUARTER FINALS --------------------->
        <!--===================================-->
        <tr>
        <td class="date-venue">Match 45<br>Quarter Final</td>        
      	<td class="left-team">
        <img src="<?php echo $Q1img; ?>" alt="<?php echo $Q1; ?>" title="<?php echo $Q1; ?>"><label for="score89_p"><?php abbrTeam($Q1); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $Q2img; ?>" alt="<?php echo $Q2; ?>" title="<?php echo $Q2; ?>"><label for="score90_p"><?php abbrTeam($Q2); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_30Jun, $venue4"; ?></td>
      	</tr>

      	<tr>
        <td class="date-venue">Match 46<br>Quarter Final</td>        
      	<td class="left-team">
        <img src="<?php echo $Q3img; ?>" alt="<?php echo $Q3; ?>" title="<?php echo $Q3; ?>"><label for="score91_p"><?php abbrTeam($Q3); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $Q4img; ?>" alt="<?php echo $Q4; ?>" title="<?php echo $Q4; ?>"><label for="score92_p"><?php abbrTeam($Q4); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_01Jul, $venue6"; ?></td>
      	</tr>                        

        <tr>
        <td class="date-venue">Match 47<br>Quarter Final</td>        
      	<td class="left-team">
        <img src="<?php echo $Q5img; ?>" alt="<?php echo $Q5; ?>" title="<?php echo $Q5; ?>"><label for="score93_p"><?php abbrTeam($Q5); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $Q6img; ?>" alt="<?php echo $Q6; ?>" title="<?php echo $Q6; ?>"><label for="score94_p"><?php abbrTeam($Q6); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_02Jul, $venue12"; ?></td>
      	</tr>

      	<tr>
        <td class="date-venue">Match 48<br>Quarter Final</td>        
      	<td class="left-team">
        <img src="<?php echo $Q7img; ?>" alt="<?php echo $Q7; ?>" title="<?php echo $Q7; ?>"><label for="score95_p"><?php abbrTeam($Q7); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $Q8img; ?>" alt="<?php echo $Q8; ?>" title="<?php echo $Q8; ?>"><label for="score96_p"><?php abbrTeam($Q8); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_03Jul, $venue1"; ?></td>
      	</tr>
        
		<!-- SEMI FINALS ------------------------>
        <!--===================================-->        
      	<tr>
        <td class="date-venue">Match 49<br>Semi Final</td>        
      	<td class="left-team">
        <img src="<?php echo $S1img; ?>" alt="<?php echo $S1; ?>" title="<?php echo $S1; ?>"><label for="score97_p"><?php abbrTeam($S1); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $S2img; ?>" alt="<?php echo $S2; ?>" title="<?php echo $S2; ?>"><label for="score98_p"><?php abbrTeam($S2); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_06Jul, $venue14"; ?></td>
      	</tr>         
        
      	<tr>
        <td class="date-venue">Match 50<br>Semi Final</td>        
      	<td class="left-team">
        <img src="<?php echo $S3img; ?>" alt="<?php echo $S3; ?>" title="<?php echo $S3; ?>"><label for="score99_p"><?php abbrTeam($S3); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $S4img; ?>" alt="<?php echo $S4; ?>" title="<?php echo $S4; ?>"><label for="score100_p"><?php abbrTeam($S4); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_07Jul, $venue4"; ?></td>
      	</tr>
        
		<!-- THE BIG FINAL ---------------------->
        <!--===================================-->        
      	<tr>
        <td class="date-venue">Match 51<br>Final</td>        
      	<td class="left-team">
        <img src="<?php echo $Fi1img; ?>" alt="<?php echo $Fi1; ?>" title="<?php echo $Fi1; ?>"><label for="score101_p"><?php abbrTeam($Fi1); ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo $Fi2img; ?>" alt="<?php echo $Fi2; ?>" title="<?php echo $Fi2; ?>"><label for="score102_p"><?php abbrTeam($Fi2); ?></label></td>
      	<td class="date-venue"><?php echo "$_8pm, $_10Jul, $venue1"; ?></td>
      	</tr>                        
      	</table>
    ...
    <script type="text/javascript">
		...
		$(document).ready(function(e) {
			...
			var lockdown = ["10-06-2016 18:00:00", <!--Fixture 1-->
							"11-06-2016 12:00:00", <!--Fixture 2-->
							"11-06-2016 15:00:00", <!--Fixture 3-->
							"11-06-2016 18:00:00", <!--Fixture 4-->
							"12-06-2016 12:00:00", <!--Fixture 5-->
							"12-06-2016 15:00:00", <!--Fixture 6-->
							"12-06-2016 18:00:00", <!--Fixture 7-->
							"13-06-2016 12:00:00", <!--Fixture 8-->
							"13-06-2016 15:00:00", <!--Fixture 9-->
							"13-06-2016 18:00:00", <!--Fixture 10-->
							"14-06-2016 15:00:00", <!--Fixture 11-->
							"14-06-2016 18:00:00", <!--Fixture 12-->
							"15-06-2016 12:00:00", <!--Fixture 13-->
							"15-06-2016 15:00:00", <!--Fixture 14-->
							"15-06-2016 18:00:00", <!--Fixture 15-->
							"16-06-2016 12:00:00", <!--Fixture 16-->
							"16-06-2016 15:00:00", <!--Fixture 17-->
							"16-06-2016 18:00:00", <!--Fixture 18-->
							"17-06-2016 12:00:00", <!--Fixture 19-->
							"17-06-2016 15:00:00", <!--Fixture 20-->
							"17-06-2016 18:00:00", <!--Fixture 21-->
							"18-06-2016 12:00:00", <!--Fixture 22-->
							"18-06-2016 15:00:00", <!--Fixture 23-->
							"18-06-2016 18:00:00", <!--Fixture 24-->
							"19-06-2016 18:00:00", <!--Fixture 25-->
							"19-06-2016 18:00:00", <!--Fixture 26-->
							"20-06-2016 18:00:00", <!--Fixture 27-->
							"20-06-2016 18:00:00", <!--Fixture 28-->
							"21-06-2016 15:00:00", <!--Fixture 29-->
							"21-06-2016 15:00:00", <!--Fixture 30-->
							"21-06-2016 18:00:00", <!--Fixture 31-->
							"21-06-2016 18:00:00", <!--Fixture 32-->
							"22-06-2016 15:00:00", <!--Fixture 33-->
							"22-06-2016 15:00:00", <!--Fixture 34-->
							"22-06-2016 18:00:00", <!--Fixture 35-->
							"22-06-2016 18:00:00", <!--Fixture 36-->
							"25-06-2016 12:00:00", <!--Fixture 37-->
							"25-06-2016 15:00:00", <!--Fixture 38-->
							"25-06-2016 18:00:00", <!--Fixture 39-->
							"26-06-2016 12:00:00", <!--Fixture 40-->
							"26-06-2016 15:00:00", <!--Fixture 41-->
							"26-06-2016 18:00:00", <!--Fixture 42-->
							"27-06-2016 15:00:00", <!--Fixture 43-->
							"27-06-2016 18:00:00", <!--Fixture 44-->
							"30-06-2016 18:00:00", <!--Fixture 45-->
							"01-07-2016 18:00:00", <!--Fixture 46-->
							"02-07-2016 18:00:00", <!--Fixture 47-->
							"03-07-2016 18:00:00", <!--Fixture 48-->
							"06-07-2016 18:00:00", <!--Fixture 49-->
							"07-07-2016 18:00:00", <!--Fixture 50-->
							"10-07-2016 18:00:00"  <!--Fixture 51-->
							];			
										
			for (i=1, j=2, k=0; i<103, j<103; i+=2, j+=2, k++) {
		...
		function showOnly(GoS) {
			// GoS = Group or Stage
			if (GoS == "All") {				
				$("#groups, #groupA, #groupB, #groupC, #groupD, #groupE, #groupF, #ro16, #qf, #sf, #final").removeClass("active");
				$("#all").addClass("active");
				$("tr:has(td:contains('Group A')), tr:has(td:contains('Group B')), tr:has(td:contains('Group C')), tr:has(td:contains('Group D')), tr:has(td:contains('Group E')), tr:has(td:contains('Group F')), tr:has(td:contains('RO16')), tr:has(td:contains('Quarter')), tr:has(td:contains('Semi')), tr:has(td:contains('Final'))").show();
			}
			if (GoS == "Groups") {				
				$("#groupA, #groupB, #groupC, #groupD, #groupE, #groupF, #ro16, #qf, #sf, #final").removeClass("active");
				$("#groups").addClass("active");
				$("tr:has(td:contains('RO16')), tr:has(td:contains('Quarter')), tr:has(td:contains('Semi')), tr:has(td:contains('Final'))").hide();				
				$("tr:has(td:contains('Group A')), tr:has(td:contains('Group B')), tr:has(td:contains('Group C')), tr:has(td:contains('Group D')), tr:has(td:contains('Group E')), tr:has(td:contains('Group F'))").show();
			}							
			if (GoS == 'A') {
			...
			if (GoS == 'RO16') {
				$("#all, #groups, #groupA, #groupB, #groupC, #groupD, #groupE, #groupF, #qf, #sf, #final").removeClass("active");
				$("#ro16").addClass("active");
				$("tr:has(td:contains('Group A')), tr:has(td:contains('Group B')), tr:has(td:contains('Group C')), tr:has(td:contains('Group D')), tr:has(td:contains('Group E')), tr:has(td:contains('Group F')), tr:has(td:contains('Quarter')), tr:has(td:contains('Semi')), tr:has(td:contains('Final'))").hide();
				$("tr:has(td:contains('RO16'))").show();
			}
			if (GoS == 'QF') {
				$("#all, #groups, #groupA, #groupB, #groupC, #groupD, #groupE, #groupF, #ro16, #sf, #final").removeClass("active");
				$("#qf").addClass("active");
				$("tr:has(td:contains('Group A')), tr:has(td:contains('Group B')), tr:has(td:contains('Group C')), tr:has(td:contains('Group D')), tr:has(td:contains('Group E')), tr:has(td:contains('Group F')), tr:has(td:contains('RO16')), tr:has(td:contains('Semi')), tr:has(td:contains('Final'))").hide();
				$("tr:has(td:contains('Quarter'))").show();
			}
			if (GoS == 'SF') {
				$("#all, #groups, #groupA, #groupB, #groupC, #groupD, #groupE, #groupF, #ro16, #qf, #final").removeClass("active");
				$("#sf").addClass("active");
				$("tr:has(td:contains('Group A')), tr:has(td:contains('Group B')), tr:has(td:contains('Group C')), tr:has(td:contains('Group D')), tr:has(td:contains('Group E')), tr:has(td:contains('Group F')), tr:has(td:contains('RO16')), tr:has(td:contains('Quarter')), tr:has(td:contains('Final'))").hide();
			...
			if (GoS == 'Final') {
				...
				$("tr:has(td:contains('Group A')), tr:has(td:contains('Group B')), tr:has(td:contains('Group C')), tr:has(td:contains('Group D')), tr:has(td:contains('Group E')), tr:has(td:contains('Group F')), tr:has(td:contains('RO16')), tr:has(td:contains('Quarter')), tr:has(td:contains('Semi'))").hide();
				$("tr:has(td:contains('Match 51'))").show();
			}
			if (GoS == '10Jun') {
				$("#all, #groups, #groupA, #groupB, #groupC, #groupD, #groupE, #groupF, #ro16, #qf, #sf").removeClass("active");
				$("#final").addClass("active");
