...
function updateMoveStatus() {
	...
	// Create a query to return the rankings information
	$sql_getrankings = "SELECT live_user_information.id, live_user_information.firstname, live_user_information.surname, live_user_information.faveteam, live_user_information.startpos, live_user_information.currpos, live_user_information.lastpos, live_user_predictions.points_total,
...
function compareValues() {
	...
	SUM(score121_r) as score121_r, SUM(score122_r) as score122_r, SUM(score123_r) as score123_r, SUM(score124_r) as score124_r, SUM(score125_r) as score125_r, SUM(score126_r) as score126_r, SUM(score127_r) as score127_r, SUM(score128_r) as score128_r FROM live_match_results";
	...
	foreach ($usernames as $usernamevalue) {
		...
		$sql_setblankpoints = "UPDATE live_user_predictions SET points_total = points_total + '".$blank_points."' WHERE username='".$usernamevalue."'";
...
function insertMatchResult() {
	...
	VALUES ('$_POST[score1_r]','$_POST[score2_r]','$_POST[score3_r]','$_POST[score4_r]','$_POST[score5_r]','$_POST[score6_r]','$_POST[score7_r]','$_POST[score8_r]','$_POST[score9_r]','$_POST[score10_r]','$_POST[score11_r]','$_POST[score12_r]','$_POST[score13_r]','$_POST[score14_r]','$_POST[score15_r]','$_POST[score16_r]','$_POST[score17_r]','$_POST[score18_r]','$_POST[score19_r]','$_POST[score20_r]','$_POST[score21_r]','$_POST[score22_r]','$_POST[score23_r]','$_POST[score24_r]','$_POST[score25_r]','$_POST[score26_r]','$_POST[score27_r]','$_POST[score28_r]','$_POST[score29_r]','$_POST[score30_r]','$_POST[score31_r]','$_POST[score32_r]','$_POST[score33_r]','$_POST[score34_r]','$_POST[score35_r]','$_POST[score36_r]','$_POST[score37_r]','$_POST[score38_r]','$_POST[score39_r]','$_POST[score40_r]','$_POST[score41_r]','$_POST[score42_r]','$_POST[score43_r]','$_POST[score44_r]','$_POST[score45_r]','$_POST[score46_r]','$_POST[score47_r]','$_POST[score48_r]','$_POST[score49_r]','$_POST[score50_r]','$_POST[score51_r]','$_POST[score52_r]','$_POST[score53_r]','$_POST[score54_r]','$_POST[score55_r]','$_POST[score56_r]','$_POST[score57_r]','$_POST[score58_r]','$_POST[score59_r]','$_POST[score60_r]','$_POST[score61_r]','$_POST[score62_r]','$_POST[score63_r]','$_POST[score64_r]','$_POST[score65_r]','$_POST[score66_r]','$_POST[score67_r]','$_POST[score68_r]','$_POST[score69_r]','$_POST[score70_r]','$_POST[score71_r]','$_POST[score72_r]','$_POST[score73_r]','$_POST[score74_r]','$_POST[score75_r]','$_POST[score76_r]','$_POST[score77_r]','$_POST[score78_r]','$_POST[score79_r]','$_POST[score80_r]','$_POST[score81_r]','$_POST[score82_r]','$_POST[score83_r]','$_POST[score84_r]','$_POST[score85_r]','$_POST[score86_r]','$_POST[score87_r]','$_POST[score88_r]','$_POST[score89_r]','$_POST[score90_r]','$_POST[score91_r]','$_POST[score92_r]','$_POST[score93_r]','$_POST[score94_r]','$_POST[score95_r]','$_POST[score96_r]','$_POST[score97_r]','$_POST[score98_r]','$_POST[score99_r]','$_POST[score100_r]','$_POST[score101_r]','$_POST[score102_r]','$_POST[score103_r]','$_POST[score104_r]','$_POST[score105_r]','$_POST[score106_r]','$_POST[score107_r]','$_POST[score108_r]','$_POST[score109_r]','$_POST[score110_r]','$_POST[score111_r]','$_POST[score112_r]','$_POST[score113_r]','$_POST[score114_r]','$_POST[score115_r]','$_POST[score116_r]','$_POST[score117_r]','$_POST[score118_r]','$_POST[score119_r]','$_POST[score120_r]','$_POST[score121_r]','$_POST[score122_r]','$_POST[score123_r]','$_POST[score124_r]','$_POST[score125_r]','$_POST[score126_r]','$_POST[score127_r]','$_POST[score128_r]')";
...
function updatePredictions() {
	...
	$sql_update = "UPDATE live_user_predictions SET score1_p = '$_POST[score1_p]', score2_p = '$_POST[score2_p]', score3_p = '$_POST[score3_p]', score4_p = '$_POST[score4_p]', score5_p = '$_POST[score5_p]', score6_p = '$_POST[score6_p]', score7_p = '$_POST[score7_p]', score8_p = '$_POST[score8_p]', score9_p = '$_POST[score9_p]', score10_p = '$_POST[score10_p]', score11_p = '$_POST[score11_p]', score12_p = '$_POST[score12_p]', score13_p = '$_POST[score13_p]', score14_p = '$_POST[score14_p]', score15_p = '$_POST[score15_p]', score16_p = '$_POST[score16_p]', score17_p = '$_POST[score17_p]', score18_p = '$_POST[score18_p]', score19_p = '$_POST[score19_p]', score20_p = '$_POST[score20_p]', score21_p = '$_POST[score21_p]', score22_p = '$_POST[score22_p]', score23_p = '$_POST[score23_p]', score24_p = '$_POST[score24_p]', score25_p = '$_POST[score25_p]', score26_p = '$_POST[score26_p]', score27_p = '$_POST[score27_p]', score28_p = '$_POST[score28_p]', score29_p = '$_POST[score29_p]', score30_p = '$_POST[score30_p]', score31_p = '$_POST[score31_p]', score32_p = '$_POST[score32_p]', score33_p = '$_POST[score33_p]', score34_p = '$_POST[score34_p]', score35_p = '$_POST[score35_p]', score36_p = '$_POST[score36_p]', score37_p = '$_POST[score37_p]', score38_p = '$_POST[score38_p]', score39_p = '$_POST[score39_p]', score40_p = '$_POST[score40_p]', score41_p = '$_POST[score41_p]', score42_p = '$_POST[score42_p]', score43_p = '$_POST[score43_p]', score44_p = '$_POST[score44_p]', score45_p = '$_POST[score45_p]', score46_p = '$_POST[score46_p]', score47_p = '$_POST[score47_p]', score48_p = '$_POST[score48_p]', score49_p = '$_POST[score49_p]', score50_p = '$_POST[score50_p]', score51_p = '$_POST[score51_p]', score52_p = '$_POST[score52_p]', score53_p = '$_POST[score53_p]', score54_p = '$_POST[score54_p]', score55_p = '$_POST[score55_p]', score56_p = '$_POST[score56_p]', score57_p = '$_POST[score57_p]', score58_p = '$_POST[score58_p]', score59_p = '$_POST[score59_p]', score60_p = '$_POST[score60_p]', score61_p = '$_POST[score61_p]', score62_p = '$_POST[score62_p]', score63_p = '$_POST[score63_p]', score64_p = '$_POST[score64_p]', score65_p = '$_POST[score65_p]', score66_p = '$_POST[score66_p]', score67_p = '$_POST[score67_p]', score68_p = '$_POST[score68_p]', score69_p = '$_POST[score69_p]', score70_p = '$_POST[score70_p]', score71_p = '$_POST[score71_p]', score72_p = '$_POST[score72_p]', score73_p = '$_POST[score73_p]', score74_p = '$_POST[score74_p]', score75_p = '$_POST[score75_p]', score76_p = '$_POST[score76_p]', score77_p = '$_POST[score77_p]', score78_p = '$_POST[score78_p]', score79_p = '$_POST[score79_p]', score80_p = '$_POST[score80_p]', score81_p = '$_POST[score81_p]', score82_p = '$_POST[score82_p]', score83_p = '$_POST[score83_p]', score84_p = '$_POST[score84_p]', score85_p = '$_POST[score85_p]', score86_p = '$_POST[score86_p]', score87_p = '$_POST[score87_p]', score88_p = '$_POST[score88_p]', score89_p = '$_POST[score89_p]', score90_p = '$_POST[score90_p]', score91_p = '$_POST[score91_p]', score92_p = '$_POST[score92_p]', score93_p = '$_POST[score93_p]', score94_p = '$_POST[score94_p]', score95_p = '$_POST[score95_p]', score96_p = '$_POST[score96_p]', score97_p = '$_POST[score97_p]', score98_p = '$_POST[score98_p]', score99_p = '$_POST[score99_p]', score100_p = '$_POST[score100_p]', score101_p = '$_POST[score101_p]', score102_p = '$_POST[score102_p]', score103_p = '$_POST[score103_p]', score104_p = '$_POST[score104_p]', score105_p = '$_POST[score105_p]', score106_p = '$_POST[score106_p]', score107_p = '$_POST[score107_p]', score108_p = '$_POST[score108_p]', score109_p = '$_POST[score109_p]', score110_p = '$_POST[score110_p]', score111_p = '$_POST[score111_p]', score112_p = '$_POST[score112_p]', score113_p = '$_POST[score113_p]', score114_p = '$_POST[score114_p]', score115_p = '$_POST[score115_p]', score116_p = '$_POST[score116_p]', score117_p = '$_POST[score117_p]', score118_p = '$_POST[score118_p]', score119_p = '$_POST[score119_p]', score120_p = '$_POST[score120_p]', score121_p = '$_POST[score121_p]', score122_p = '$_POST[score122_p]', score123_p = '$_POST[score123_p]', score124_p = '$_POST[score124_p]', score125_p = '$_POST[score125_p]', score126_p = '$_POST[score126_p]', score127_p = '$_POST[score127_p]', score128_p = '$_POST[score128_p]', lastupdate = NOW() WHERE id='{$_SESSION['id']}'";
...
function insertPredictions() {
	...
	$sql_insert = "INSERT INTO live_user_predictions (id, username, firstname, surname, score1_p, score2_p, score3_p, score4_p, score5_p, score6_p, score7_p, score8_p, score9_p, score10_p, score11_p, score12_p, score13_p, score14_p, score15_p, score16_p, score17_p, score18_p, score19_p, score20_p, score21_p, score22_p, score23_p, score24_p, score25_p, score26_p, score27_p, score28_p, score29_p, score30_p, score31_p, score32_p, score33_p, score34_p, score35_p, score36_p, score37_p, score38_p, score39_p, score40_p, score41_p, score42_p, score43_p, score44_p, score45_p, score46_p, score47_p, score48_p, score49_p, score50_p, score51_p, score52_p, score53_p, score54_p, score55_p, score56_p, score57_p, score58_p, score59_p, score60_p, score61_p, score62_p, score63_p, score64_p, score65_p, score66_p, score67_p, score68_p, score69_p, score70_p, score71_p, score72_p, score73_p, score74_p, score75_p, score76_p, score77_p, score78_p, score79_p, score80_p, score81_p, score82_p, score83_p, score84_p, score85_p, score86_p, score87_p, score88_p, score89_p, score90_p, score91_p, score92_p, score93_p, score94_p, score95_p, score96_p, score97_p, score98_p, score99_p, score100_p, score101_p, score102_p, score103_p, score104_p, score105_p, score106_p, score107_p, score108_p, score109_p, score110_p, score111_p, score112_p, score113_p, score114_p, score115_p, score116_p, score117_p, score118_p, score119_p, score120_p, score121_p, score122_p, score123_p, score124_p, score125_p, score126_p, score127_p, score128_p, lastupdate)
			   VALUES ('{$_SESSION['id']}','{$_SESSION['username']}','{$_SESSION['firstname']}','{$_SESSION['surname']}','$_POST[score1_p]','$_POST[score2_p]','$_POST[score3_p]','$_POST[score4_p]','$_POST[score5_p]','$_POST[score6_p]','$_POST[score7_p]','$_POST[score8_p]','$_POST[score9_p]','$_POST[score10_p]','$_POST[score11_p]','$_POST[score12_p]','$_POST[score13_p]','$_POST[score14_p]','$_POST[score15_p]','$_POST[score16_p]','$_POST[score17_p]','$_POST[score18_p]','$_POST[score19_p]','$_POST[score20_p]','$_POST[score21_p]','$_POST[score22_p]','$_POST[score23_p]','$_POST[score24_p]','$_POST[score25_p]','$_POST[score26_p]','$_POST[score27_p]','$_POST[score28_p]','$_POST[score29_p]','$_POST[score30_p]','$_POST[score31_p]','$_POST[score32_p]','$_POST[score33_p]','$_POST[score34_p]','$_POST[score35_p]','$_POST[score36_p]','$_POST[score37_p]','$_POST[score38_p]','$_POST[score39_p]','$_POST[score40_p]','$_POST[score41_p]','$_POST[score42_p]','$_POST[score43_p]','$_POST[score44_p]','$_POST[score45_p]','$_POST[score46_p]','$_POST[score47_p]','$_POST[score48_p]','$_POST[score49_p]','$_POST[score50_p]','$_POST[score51_p]','$_POST[score52_p]','$_POST[score53_p]','$_POST[score54_p]','$_POST[score55_p]','$_POST[score56_p]','$_POST[score57_p]','$_POST[score58_p]','$_POST[score59_p]','$_POST[score60_p]','$_POST[score61_p]','$_POST[score62_p]','$_POST[score63_p]','$_POST[score64_p]','$_POST[score65_p]','$_POST[score66_p]','$_POST[score67_p]','$_POST[score68_p]','$_POST[score69_p]','$_POST[score70_p]','$_POST[score71_p]','$_POST[score72_p]','$_POST[score73_p]','$_POST[score74_p]','$_POST[score75_p]','$_POST[score76_p]','$_POST[score77_p]','$_POST[score78_p]','$_POST[score79_p]','$_POST[score80_p]','$_POST[score81_p]','$_POST[score82_p]','$_POST[score83_p]','$_POST[score84_p]','$_POST[score85_p]','$_POST[score86_p]','$_POST[score87_p]','$_POST[score88_p]','$_POST[score89_p]','$_POST[score90_p]','$_POST[score91_p]','$_POST[score92_p]','$_POST[score93_p]','$_POST[score94_p]','$_POST[score95_p]','$_POST[score96_p]','$_POST[score97_p]','$_POST[score98_p]','$_POST[score99_p]','$_POST[score100_p]','$_POST[score101_p]','$_POST[score102_p]','$_POST[score103_p]','$_POST[score104_p]','$_POST[score105_p]','$_POST[score106_p]','$_POST[score107_p]','$_POST[score108_p]','$_POST[score109_p]','$_POST[score110_p]','$_POST[score111_p]','$_POST[score112_p]','$_POST[score113_p]','$_POST[score114_p]','$_POST[score115_p]','$_POST[score116_p]','$_POST[score117_p]','$_POST[score118_p]','$_POST[score119_p]','$_POST[score120_p]','$_POST[score121_p]','$_POST[score122_p]','$_POST[score123_p]','$_POST[score124_p]','$_POST[score125_p]','$_POST[score126_p]','$_POST[score127_p]','$_POST[score128_p]', NOW())";
...
function submitPredictions() {
	...
	include 'php/db-connect.php';
  	...
  	$sql_exists = "SELECT * FROM live_user_predictions WHERE id='{$_SESSION['id']}'";
...
function displayRankings() {
	...
	$sql_maketable = "SELECT live_user_information.id, live_user_information.firstname, live_user_information.surname, live_user_information.avatar, live_user_information.faveteam, live_user_information.startpos, live_user_information.currpos, live_user_information.lastpos, live_user_predictions.points_total,
						FIND_IN_SET(points_total, (
							SELECT GROUP_CONCAT( DISTINCT points_total
							ORDER BY points_total DESC )
							FROM live_user_predictions )
