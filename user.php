      ...
      <div class="container-fluid">
        ...
        <div id="navbar2" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-left">
            ...
            $sql_getuserinfo = "SELECT live_user_predictions.*, live_user_information.avatar, live_user_information.faveteam, live_user_information.fieldofwork, live_user_information.tournwinner, live_user_information.prevrank, live_user_information.currpos FROM live_user_predictions INNER JOIN live_user_information ON live_user_predictions.id = live_user_information.id 
			...
			$prevrank = $userdata["prevrank"];
			$lastupdate = $userdata["lastupdate"];
			$lastupdated = date("D, M jS @ H:i", strtotime($lastupdate));
    ...
    <div class="panel panel-default">
	  	<div class="panel-body">
		    <div class="row" style="">
              <div class="col-md-2 col-xs-12">
                ...
                <?php printf("<p class='text-center 'style='font-size: 1.5em; color: #222;'><strong>%s&nbsp;&nbsp;<span style='color:#CCC;'>|</span>&nbsp;&nbsp;%spt(s)</strong></p>", $currentpos, $pointstotal); ?>
              </div>
              <div class="col-md-10 col-xs-12">
                <p><?php printf ("%s thinks %s will win the UEFA Euro 2016 competition.", $uppCaseFN, $tournwinner); ?></p>
                <p><?php printf ("<strong>Favourite Team:</strong> %s", $faveteam); ?></p>
                <p><?php printf ("<strong>Field of Work:</strong> %s", $fieldofwork); ?></p>
                <p><?php printf ("<strong>World Cup 2014 Rank:</strong> %s", $prevrank); ?></p>
      ...
      <div class="col-xs-12">
        ...
        <td class="date-venue">Match 3<br>Group B</td>
      	<td class="left-team">
        <img src="<?php echo $B1img; ?>" alt="<?php echo $B1; ?>" title="<?php echo $B1; ?>"><label for="score5_p"><?php echo $B1; ?></label></td>        
       	<td align="center"><span>v</span></td>
        <td class="right-team">
        <img src="<?php echo $B2img; ?>" alt="<?php echo $B2; ?>" title="<?php echo $B2; ?>"><label for="score6_p"><?php echo $B2; ?></label></td>
        ...
        <td class="left-team">        
        <img src="<?php echo $B3img; ?>" alt="<?php echo $B3; ?>" title="<?php echo $B3; ?>"><label for="score7_p"><?php echo $B3; ?></label></td>        
        <td align="center"><span>v</span></td>
      	<td class="right-team">
        <img src="<?php echo $B4img; ?>" alt="<?php echo $B4; ?>" title="<?php echo $B4; ?>"><label for="score8_p"><?php echo $B4; ?></label></td>        
        ...
        <td class="date-venue">Match 5<br>Group D</td>
      	<td class="left-team">
		<img src="<?php echo $D1img; ?>" alt="<?php echo $D1; ?>" title="<?php echo $D1; ?>"><label for="score9_p"><?php echo $D1; ?></label></td>        
        <td align="center"><span>v</span></td>
      	<td class="right-team">
		<img src="<?php echo $D2img; ?>" alt="<?php echo $D2; ?>" title="<?php echo $D2; ?>"><label for="score10_p"><?php echo $D2; ?></label></td>
        ...
        <td class="date-venue">Match 6<br>Group C</td>
      	<td class="left-team">
        <img src="<?php echo $C1img; ?>" alt="<?php echo $C1; ?>" title="<?php echo $C1; ?>"><label for="score11_p"><?php echo $C1; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $C2img; ?>" alt="<?php echo $C2; ?>" title="<?php echo $C2; ?>"><label for="score12_p"><?php echo $C2; ?></label></td>
	    ...
	    <td class="left-team">
        <img src="<?php echo $E1img; ?>" alt="<?php echo $E1; ?>" title="<?php echo $E1; ?>"><label for="score17_p"><?php echo $E1; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $E2img; ?>" alt="<?php echo $E2; ?>" title="<?php echo $E2; ?>"><label for="score18_p"><?php echo $E2; ?></label></td>
        ...
        <td class="date-venue">Match 10<br>Group E</td>
      	<td class="left-team">
        <img src="<?php echo $E3img; ?>" alt="<?php echo $E3; ?>" title="<?php echo $E3; ?>"><label for="score19_p"><?php echo $E3; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $E4img; ?>" alt="<?php echo $E4; ?>" title="<?php echo $E4; ?>"><label for="score20_p"><?php echo $E4; ?></label></td>
        ...
        <td class="date-venue">Match 11<br>Group F</td>
      	<td class="left-team">
        <img src="<?php echo $F1img; ?>" alt="<?php echo $F1; ?>" title="<?php echo $F1; ?>"><label for="score21_p"><?php echo $F1; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $F2img; ?>" alt="<?php echo $F2; ?>" title="<?php echo $F2; ?>"><label for="score22_p"><?php echo $F2; ?></label></td>
	    ...
	    <td class="left-team">
        <img src="<?php echo $B4img; ?>" alt="<?php echo $B4; ?>" title="<?php echo $B4; ?>"><label for="score25_p"><?php echo $B4; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $B2img; ?>" alt="<?php echo $B2; ?>" title="<?php echo $B2; ?>"><label for="score26_p"><?php echo $B2; ?></label></td>
        ...
        <td class="date-venue">Match 14<br>Group A</td>
      	<td class="left-team">
        <img src="<?php echo $A2img; ?>" alt="<?php echo $A2; ?>" title="<?php echo $A2; ?>"><label for="score27_p"><?php echo $A2; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $A4img; ?>" alt="<?php echo $A4; ?>" title="<?php echo $A4; ?>"><label for="score28_p"><?php echo $A4; ?></label></td>
        ...
        <td class="date-venue">Match 15<br>Group A</td>
      	<td class="left-team">
        <img src="<?php echo $A1img; ?>" alt="<?php echo $A1; ?>" title="<?php echo $A1; ?>"><label for="score29_p"><?php echo $A1; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $A3img; ?>" alt="<?php echo $A3; ?>" title="<?php echo $A3; ?>"><label for="score30_p"><?php echo $A3; ?></label></td>
        ...
        <td class="date-venue">Match 16<br>Group B</td>
      	<td class="left-team">
        <img src="<?php echo $B3img; ?>" alt="<?php echo $B3; ?>" title="<?php echo $B3; ?>"><label for="score31_p"><?php echo $B3; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $B1img; ?>" alt="<?php echo $B1; ?>" title="<?php echo $B1; ?>"><label for="score32_p"><?php echo $B1; ?></label></td>
	    ...
	    <td class="left-team">
        <img src="<?php echo $C4img; ?>" alt="<?php echo $C4; ?>" title="<?php echo $C4; ?>"><label for="score33_p"><?php echo $C4; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $C2img; ?>" alt="<?php echo $C2; ?>" title="<?php echo $C2; ?>"><label for="score34_p"><?php echo $C2; ?></label></td>
        ...
        <td class="date-venue">Match 18<br>Group C</td>
      	<td class="left-team">
        <img src="<?php echo $C3img; ?>" alt="<?php echo $C3; ?>" title="<?php echo $C3; ?>"><label for="score35_p"><?php echo $C3; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $C1img; ?>" alt="<?php echo $C1; ?>" title="<?php echo $C1; ?>"><label for="score36_p"><?php echo $C1; ?></label></td>
        ...
        <td class="date-venue">Match 19<br>Group E</td>
      	<td class="left-team">
        <img src="<?php echo $E4img; ?>" alt="<?php echo $E4; ?>" title="<?php echo $E4; ?>"><label for="score37_p"><?php echo $E4; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $E2img; ?>" alt="<?php echo $E2; ?>" title="<?php echo $E2; ?>"><label for="score38_p"><?php echo $E2; ?></label></td>
        ...
        <td class="date-venue">Match 20<br>Group D</td>
      	<td class="left-team">
        <img src="<?php echo $D4img; ?>" alt="<?php echo $D4; ?>" title="<?php echo $D4; ?>"><label for="score39_p"><?php echo $D4; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $D2img; ?>" alt="<?php echo $D2; ?>" title="<?php echo $D2; ?>"><label for="score40_p"><?php echo $D2; ?></label></td>
        ...
        <td class="date-venue">Match 21<br>Group D</td>
      	<td class="left-team">
        <img src="<?php echo $D3img; ?>" alt="<?php echo $D3; ?>" title="<?php echo $D3; ?>"><label for="score41_p"><?php echo $D3; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $D1img; ?>" alt="<?php echo $D1; ?>" title="<?php echo $D1; ?>"><label for="score42_p"><?php echo $D1; ?></label></td>
        ...
        <td class="date-venue">Match 22<br>Group E</td>
      	<td class="left-team">
        <img src="<?php echo $E3img; ?>" alt="<?php echo $E3; ?>" title="<?php echo $E3; ?>"><label for="score43_p"><?php echo $E3; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $E1img; ?>" alt="<?php echo $E1; ?>" title="<?php echo $E1; ?>"><label for="score44_p"><?php echo $E1; ?></label></td>
	    ...
	    <td class="left-team">
        <img src="<?php echo $F4img; ?>" alt="<?php echo $F4; ?>" title="<?php echo $F4; ?>"><label for="score45_p"><?php echo $F4; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $F2img; ?>" alt="<?php echo $F2; ?>" title="<?php echo $F2; ?>"><label for="score46_p"><?php echo $F2; ?></label></td>
        ...
        <td class="date-venue">Match 24<br>Group F</td>
      	<td class="left-team">
        <img src="<?php echo $F3img; ?>" alt="<?php echo $F3; ?>" title="<?php echo $F3; ?>"><label for="score47_p"><?php echo $F3; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $F1img; ?>" alt="<?php echo $F1; ?>" title="<?php echo $F1; ?>"><label for="score48_p"><?php echo $F1; ?></label></td>
        ...
        <td class="date-venue">Match 25<br>Group A</td>
      	<td class="left-team">
        <img src="<?php echo $A4img; ?>" alt="<?php echo $A4; ?>" title="<?php echo $A4; ?>"><label for="score49_p"><?php echo $A4; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $A1img; ?>" alt="<?php echo $A1; ?>" title="<?php echo $A1; ?>"><label for="score50_p"><?php echo $A1; ?></label></td>
        ...
        <td class="date-venue">Match 26<br>Group A</td>
      	<td class="left-team">
        <img src="<?php echo $A2img; ?>" alt="<?php echo $A2; ?>" title="<?php echo $A2; ?>"><label for="score51_p"><?php echo $A2; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $A3img; ?>" alt="<?php echo $A3; ?>" title="<?php echo $A3; ?>"><label for="score52_p"><?php echo $A3; ?></label></td>
	    ...
	    <td class="left-team">
        <img src="<?php echo $B2img; ?>" alt="<?php echo $B2; ?>" title="<?php echo $B2; ?>"><label for="score53_p"><?php echo $B2; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $B3img; ?>" alt="<?php echo $B3; ?>" title="<?php echo $B3; ?>"><label for="score54_p"><?php echo $B3; ?></label></td>
		...
		<td class="date-venue">Match 28<br>Group B</td>
      	<td class="left-team">
        <img src="<?php echo $B4img; ?>" alt="<?php echo $B4; ?>" title="<?php echo $B4; ?>"><label for="score55_p"><?php echo $B4; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $B1img; ?>" alt="<?php echo $B1; ?>" title="<?php echo $B1; ?>"><label for="score56_p"><?php echo $B1; ?></label></td>
        ...
        <td class="date-venue">Match 29<br>Group C</td>
      	<td class="left-team">
        <img src="<?php echo $C2img; ?>" alt="<?php echo $C2; ?>" title="<?php echo $C2; ?>"><label for="score57_p"><?php echo $C2; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $C3img; ?>" alt="<?php echo $C3; ?>" title="<?php echo $C3; ?>"><label for="score58_p"><?php echo $C3; ?></label></td>
        ...
        <td class="date-venue">Match 30<br>Group C</td>
      	<td class="left-team">
        <img src="<?php echo $C4img; ?>" alt="<?php echo $C4; ?>" title="<?php echo $C4; ?>"><label for="score59_p"><?php echo $C4; ?></label></td>
        <td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $C1img; ?>" alt="<?php echo $C1; ?>" title="<?php echo $C1; ?>"><label for="score60_p"><?php echo $C1; ?></label></td>
	    ...
	    <td class="left-team">
        <img src="<?php echo $D2img; ?>" alt="<?php echo $D2; ?>" title="<?php echo $D2; ?>"><label for="score61_p"><?php echo $D2; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $D3img; ?>" alt="<?php echo $D3; ?>" title="<?php echo $D3; ?>"><label for="score62_p"><?php echo $D3; ?></label></td>
        ...
        <td class="date-venue">Match 32<br>Group D</td>
      	<td class="left-team">
        <img src="<?php echo $D4img; ?>" alt="<?php echo $D4; ?>" title="<?php echo $D4; ?>"><label for="score63_p"><?php echo $D4; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $D1img; ?>" alt="<?php echo $D1; ?>" title="<?php echo $D1; ?>"><label for="score64_p"><?php echo $D1; ?></label></td>
        ...
        <td class="date-venue">Match 33<br>Group F</td>
      	<td class="left-team">
        <img src="<?php echo $F4img; ?>" alt="<?php echo $F4; ?>" title="<?php echo $F4; ?>"><label for="score65_p"><?php echo $F4; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $F1img; ?>" alt="<?php echo $F1; ?>" title="<?php echo $F1; ?>"><label for="score66_p"><?php echo $F1; ?></label></td>
        ...
        <td class="date-venue">Match 34<br>Group F</td>
      	<td class="left-team">
        <img src="<?php echo $F2img; ?>" alt="<?php echo $F2; ?>" title="<?php echo $F2; ?>"><label for="score67_p"><?php echo $F2; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $F3img; ?>" alt="<?php echo $F3; ?>" title="<?php echo $F3; ?>"><label for="score68_p"><?php echo $F3; ?></label></td>
	    ...
	    <td class="left-team">
        <img src="<?php echo $E2img; ?>" alt="<?php echo $E2; ?>" title="<?php echo $E2; ?>"><label for="score69_p"><?php echo $E2; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $E3img; ?>" alt="<?php echo $E3; ?>" title="<?php echo $E3; ?>"><label for="score70_p"><?php echo $E3; ?></label></td>
        ...
        <td class="date-venue">Match 36<br>Group E</td>
      	<td class="left-team">
        <img src="<?php echo $E4img; ?>" alt="<?php echo $E4; ?>" title="<?php echo $E4; ?>"><label for="score71_p"><?php echo $E4; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $E1img; ?>" alt="<?php echo $E1; ?>" title="<?php echo $E1; ?>"><label for="score72_p"><?php echo $E1; ?></label></td>
        ...
        <td class="date-venue">Match 37<br>RO16</td>
      	<td class="left-team">
        <img src="<?php echo $R1img; ?>" alt="<?php echo $R1; ?>" title="<?php echo $R1; ?>"><label for="score73_p"><?php echo $R1; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $R2img; ?>" alt="<?php echo $R2; ?>" title="<?php echo $R2; ?>"><label for="score74_p"><?php echo $R2; ?></label></td>
        ...
        <td class="date-venue">Match 38<br>RO16</td>
      	<td class="left-team">
        <img src="<?php echo $R3img; ?>" alt="<?php echo $R3; ?>" title="<?php echo $R3; ?>"><label for="score75_p"><?php echo $R3; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $R4img; ?>" alt="<?php echo $R4; ?>" title="<?php echo $R4; ?>"><label for="score76_p"><?php echo $R4; ?></label></td>
        ...
        <td class="date-venue">Match 39<br>RO16</td>
      	<td class="left-team">
        <img src="<?php echo $R5img; ?>" alt="<?php echo $R5; ?>" title="<?php echo $R5; ?>"><label for="score77_p"><?php echo $R5; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $R6img; ?>" alt="<?php echo $R6; ?>" title="<?php echo $R6; ?>"><label for="score78_p"><?php echo $R6; ?></label></td>
        ...
        <td class="date-venue">Match 40<br>RO16</td>
      	<td class="left-team">
        <img src="<?php echo $R7img; ?>" alt="<?php echo $R7; ?>" title="<?php echo $R7; ?>"><label for="score79_p"><?php echo $R7; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $R8img; ?>" alt="<?php echo $R8; ?>" title="<?php echo $R8; ?>"><label for="score80_p"><?php echo $R8; ?></label></td>
        ...
        <td class="date-venue">Match 41<br>RO16</td>
      	<td class="left-team">
        <img src="<?php echo $R9img; ?>" alt="<?php echo $R9; ?>" title="<?php echo $R9; ?>"><label for="score81_p"><?php echo $R9; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $R10img; ?>" alt="<?php echo $R10; ?>" title="<?php echo $R10; ?>"><label for="score82_p"><?php echo $R10; ?></label></td>
        ...
        <td class="date-venue">Match 42<br>RO16</td>
      	<td class="left-team">
        <img src="<?php echo $R11img; ?>" alt="<?php echo $R11; ?>" title="<?php echo $R11; ?>"><label for="score83_p"><?php echo $R11; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $R12img; ?>" alt="<?php echo $R12; ?>" title="<?php echo $R12; ?>"><label for="score84_p"><?php echo $R12; ?></label></td>
        ...
        <td class="date-venue">Match 43<br>RO16</td>
      	<td class="left-team">
        <img src="<?php echo $R13img; ?>" alt="<?php echo $R13; ?>" title="<?php echo $R13; ?>"><label for="score85_p"><?php echo $R13; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $R14img; ?>" alt="<?php echo $R14; ?>" title="<?php echo $R14; ?>"><label for="score86_p"><?php echo $R14; ?></label></td>
        ...
        <td class="date-venue">Match 44<br>RO16</td>
      	<td class="left-team">
        <img src="<?php echo $R15img; ?>" alt="<?php echo $R15; ?>" title="<?php echo $R15; ?>"><label for="score87_p"><?php echo $R15; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $R16img; ?>" alt="<?php echo $R16; ?>" title="<?php echo $R16; ?>"><label for="score88_p"><?php echo $R16; ?></label></td>
        ...
        <tr>
        <td class="date-venue">Match 45<br>QF</td>
      	<td class="left-team">
        <img src="<?php echo $Q1img; ?>" alt="<?php echo $Q1; ?>" title="<?php echo $Q1; ?>"><label for="score89_p"><?php echo $Q1; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $Q2img; ?>" alt="<?php echo $Q2; ?>" title="<?php echo $Q2; ?>"><label for="score90_p"><?php echo $Q2; ?></label></td>
		...
		<td align="center"><?php if($matchids[44]) { printf ("<span class='result'>%s - %s</span>", $matchresult["score".$oddgameno[44]."_r"], $matchresult["score".$evengameno[44]."_r"]); } else echo "N / A"; ?></td>
      	...
      	<tr>
        <td class="date-venue">Match 46<br>QF</td>
      	<td class="left-team">
        <img src="<?php echo $Q3img; ?>" alt="<?php echo $Q3; ?>" title="<?php echo $Q3; ?>"><label for="score91_p"><?php echo $Q3; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $Q4img; ?>" alt="<?php echo $Q4; ?>" title="<?php echo $Q4; ?>"><label for="score92_p"><?php echo $Q4; ?></label></td>
        ...
        <tr>
        <td class="date-venue">Match 47<br>QF</td>
      	<td class="left-team">
        <img src="<?php echo $Q5img; ?>" alt="<?php echo $Q5; ?>" title="<?php echo $Q5; ?>"><label for="score93_p"><?php echo $Q5; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $Q6img; ?>" alt="<?php echo $Q6; ?>" title="<?php echo $Q6; ?>"><label for="score94_p"><?php echo $Q6; ?></label></td>
		...
		<td align="center"><?php if($matchids[46]) { printf ("<span class='result'>%s - %s</span>", $matchresult["score".$oddgameno[46]."_r"], $matchresult["score".$evengameno[46]."_r"]); } else echo "N / A"; ?></td>
      	...
      	<tr>
        <td class="date-venue">Match 48<br>QF</td>
      	<td class="left-team">
        <img src="<?php echo $Q7img; ?>" alt="<?php echo $Q7; ?>" title="<?php echo $Q7; ?>"><label for="score95_p"><?php echo $Q7; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $Q8img; ?>" alt="<?php echo $Q8; ?>" title="<?php echo $Q8; ?>"><label for="score96_p"><?php echo $Q8; ?></label></td>
		...
		<td align="center"><?php if($matchids[47]) { printf ("<span class='result'>%s - %s</span>", $matchresult["score".$oddgameno[47]."_r"], $matchresult["score".$evengameno[47]."_r"]); } else echo "N / A"; ?></td>
      	...
      	<tr>
        <td class="date-venue">Match 49<br>SF</td>
      	<td class="left-team">
        <img src="<?php echo $S1img; ?>" alt="<?php echo $S1; ?>" title="<?php echo $S1; ?>"><label for="score95_p"><?php echo $S1; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $S2img; ?>" alt="<?php echo $S2; ?>" title="<?php echo $S2; ?>"><label for="score96_p"><?php echo $S2; ?></label></td>
      	<td align="center"><span class="prediction"><?php echo $userdata['score95_p'] ?> - <?php echo $userdata['score96_p'] ?></span></td>        
		<td align="center"><?php if($matchids[47]) { printf ("<span class='result'>%s - %s</span>", $matchresult["score".$oddgameno[47]."_r"], $matchresult["score".$evengameno[47]."_r"]); } else echo "N / A"; ?></td>
      	<td align="center"><?php if($matchids[47]) { echo $matchpoints[47]; } else { echo "-"; } ?></td>    
      	</tr>     
      	<tr>
        <td class="date-venue">Match 50<br>SF</td>
      	<td class="left-team">
        <img src="<?php echo $S3img; ?>" alt="<?php echo $S3; ?>" title="<?php echo $S3; ?>"><label for="score95_p"><?php echo $S3; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $S4img; ?>" alt="<?php echo $S4; ?>" title="<?php echo $S4; ?>"><label for="score96_p"><?php echo $S4; ?></label></td>
      	<td align="center"><span class="prediction"><?php echo $userdata['score95_p'] ?> - <?php echo $userdata['score96_p'] ?></span></td>        
		<td align="center"><?php if($matchids[47]) { printf ("<span class='result'>%s - %s</span>", $matchresult["score".$oddgameno[47]."_r"], $matchresult["score".$evengameno[47]."_r"]); } else echo "N / A"; ?></td>
      	<td align="center"><?php if($matchids[47]) { echo $matchpoints[47]; } else { echo "-"; } ?></td>    
      	</tr>     
        ...
        <td class="date-venue">Match 51<br>Final</td>
      	<td class="left-team">
        <img src="<?php echo $Fi1img; ?>" alt="<?php echo $Fi1; ?>" title="<?php echo $Fi1; ?>"><label for="score95_p"><?php echo $Fi1; ?></label></td>
      	<td align="center">v</td>
      	<td class="right-team">
        <img src="<?php echo $Fi2img; ?>" alt="<?php echo $Fi2; ?>" title="<?php echo $Fi2; ?>"><label for="score96_p"><?php echo $Fi2; ?></label></td>
      	<td align="center"><span class="prediction"><?php echo $userdata['score95_p'] ?> - <?php echo $userdata['score96_p'] ?></span></td>        
		<td align="center"><?php if($matchids[47]) { printf ("<span class='result'>%s - %s</span>", $matchresult["score".$oddgameno[47]."_r"], $matchresult["score".$evengameno[47]."_r"]); } else echo "N / A"; ?></td>
      	<td align="center"><?php if($matchids[47]) { echo $matchpoints[47]; } else { echo "-"; } ?></td>    
      	</tr>                                           
