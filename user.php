			                    ...
			                    $.getJSON("json/fifa-world-cup-2022-fixtures-groups.json",
			                        ...
			                        $.each(data, function (key, value) {
			                            ...
			                            fixture += '<td class="small text-muted d-none d-md-block">' + date + '</td>';
																	fixture += '<td align="center"><span class="prediction"><?php echo "$x = <script>document.writeln(x);</script>"; echo $userdata["score".$x."_p"]; ?> - <?php echo $userdata["score".$y."_p"] ?></span></td>';
