    ...
    <nav class="navbar navbar-inverse navbar-fixed-top col-md-12 visible-xs hidden-lg hidden-md">
      <div class="container-fluid">
        ...
        <td class="date-venue">Match 3<br>Group B</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $B1img; ?>" alt="<?php echo $B1; ?>" title="<?php echo $B1; ?>"><label for="score5_r"><?php echo $B1; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $B2img; ?>" alt="<?php echo $B2; ?>" title="<?php echo $B2; ?>"><label for="score6_r"><?php echo $B2; ?></label></td>
        ...
        <td class="date-venue">Match 4<br>Group B</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $B3img; ?>" alt="<?php echo $B3; ?>" title="<?php echo $B3; ?>"><label for="score7_r"><?php echo $B3; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $B4img; ?>" alt="<?php echo $B4; ?>" title="<?php echo $B4; ?>"><label for="score8_r"><?php echo $B4; ?></label></td>
	    ...
	    <td class="left-team">
        <img src="<?php echo "../" . $D1img; ?>" alt="<?php echo $D1; ?>" title="<?php echo $D1; ?>"><label for="score9_r"><?php echo $D1; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $D2img; ?>" alt="<?php echo $D2; ?>" title="<?php echo $D2; ?>"><label for="score10_r"><?php echo $D2; ?></label></td>
        ...
        <td class="date-venue">Match 6<br>Group C</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $C1img; ?>" alt="<?php echo $C1; ?>" title="<?php echo $C1; ?>"><label for="score11_r"><?php echo $C1; ?></label></td>
      	...
      	<td class="right-team">
		<img src="<?php echo "../" . $C2img; ?>" alt="<?php echo $C2; ?>" title="<?php echo $C2; ?>"><label for="score12_r"><?php echo $C2; ?></label></td>        <td class="date-venue">Match Recorded: <?php echo $matchstatus[5]; ?></td>
	    ...
	    <td class="left-team">
        <img src="<?php echo "../" . $E1img; ?>" alt="<?php echo $E1; ?>" title="<?php echo $E1; ?>"><label for="score17_r"><?php echo $E1; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $E2img; ?>" alt="<?php echo $E2; ?>" title="<?php echo $E2; ?>"><label for="score18_r"><?php echo $E2; ?></label></td>
        ...
        <td class="date-venue">Match 10<br>Group E</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $E3img; ?>" alt="<?php echo $E3; ?>" title="<?php echo $E3; ?>"><label for="score19_r"><?php echo $E3; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $E4img; ?>" alt="<?php echo $E4; ?>" title="<?php echo $E4; ?>"><label for="score20_r"><?php echo $E4; ?></label></td>
        ...
        <td class="date-venue">Match 11<br>Group F</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $F1img; ?>" alt="<?php echo $F1; ?>" title="<?php echo $F1; ?>"><label for="score21_r"><?php echo $F1; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $F2img; ?>" alt="<?php echo $F2; ?>" title="<?php echo $F2; ?>"><label for="score22_r"><?php echo $F2; ?></label></td>
	    ...
	    <td class="left-team">
        <img src="<?php echo "../" . $B4img; ?>" alt="<?php echo $B4; ?>" title="<?php echo $B4; ?>"><label for="score25_r"><?php echo $B4; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $B2img; ?>" alt="<?php echo $B2; ?>" title="<?php echo $B2; ?>"><label for="score26_r"><?php echo $B2; ?></label></td>
        ...
        <td class="date-venue">Match 14<br>Group A</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $A2img; ?>" alt="<?php echo $A2; ?>" title="<?php echo $A2; ?>"><label for="score27_r"><?php echo $A2; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $A4img; ?>" alt="<?php echo $A4; ?>" title="<?php echo $A4; ?>"><label for="score28_r"><?php echo $A4; ?></label></td>
        ...
        <td class="date-venue">Match 15<br>Group A</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $A1img; ?>" alt="<?php echo $A1; ?>" title="<?php echo $A1; ?>"><label for="score29_r"><?php echo $A1; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $A3img; ?>" alt="<?php echo $A3; ?>" title="<?php echo $A3; ?>"><label for="score30_r"><?php echo $A3; ?></label></td>
        ...
        <td class="date-venue">Match 16<br>Group B</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $B3img; ?>" alt="<?php echo $B3; ?>" title="<?php echo $B3; ?>"><label for="score31_r"><?php echo $B3; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $B1img; ?>" alt="<?php echo $B1; ?>" title="<?php echo $B1; ?>"><label for="score32_r"><?php echo $B1; ?></label></td>
	    ...
	    <td class="left-team">
        <img src="<?php echo "../" . $C4img; ?>" alt="<?php echo $C4; ?>" title="<?php echo $C4; ?>"><label for="score33_r"><?php echo $C4; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $C2img; ?>" alt="<?php echo $C2; ?>" title="<?php echo $C2; ?>"><label for="score34_r"><?php echo $C2; ?></label></td>
        ...
        <td class="date-venue">Match 18<br>Group C</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $C3img; ?>" alt="<?php echo $C3; ?>" title="<?php echo $C3; ?>"><label for="score35_r"><?php echo $C3; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $C1img; ?>" alt="<?php echo $C1; ?>" title="<?php echo $C1; ?>"><label for="score36_r"><?php echo $C1; ?></label></td>
        ...
        <td class="date-venue">Match 19<br>Group E</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $E4img; ?>" alt="<?php echo $E4; ?>" title="<?php echo $E4; ?>"><label for="score37_r"><?php echo $E4; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $E2img; ?>" alt="<?php echo $E2; ?>" title="<?php echo $E2; ?>"><label for="score38_r"><?php echo $E2; ?></label></td>
        ...
        <td class="date-venue">Match 20<br>Group D</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $D4img; ?>" alt="<?php echo $D4; ?>" title="<?php echo $D4; ?>"><label for="score39_r"><?php echo $D4; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $D2img; ?>" alt="<?php echo $D2; ?>" title="<?php echo $D2; ?>"><label for="score40_r"><?php echo $D2; ?></label></td>
        ...
        <td class="date-venue">Match 21<br>Group D</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $D3img; ?>" alt="<?php echo $D3; ?>" title="<?php echo $D3; ?>"><label for="score41_r"><?php echo $D3; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $D1img; ?>" alt="<?php echo $D1; ?>" title="<?php echo $D1; ?>"><label for="score42_r"><?php echo $D1; ?></label></td>
        ...
        <td class="date-venue">Match 22<br>Group E</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $E3img; ?>" alt="<?php echo $E3; ?>" title="<?php echo $E3; ?>"><label for="score43_r"><?php echo $E3; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $E1img; ?>" alt="<?php echo $E1; ?>" title="<?php echo $E1; ?>"><label for="score44_r"><?php echo $E1; ?></label></td>
	    ...
	    <td class="left-team">
        <img src="<?php echo "../" . $F4img; ?>" alt="<?php echo $F4; ?>" title="<?php echo $F4; ?>"><label for="score45_r"><?php echo $F4; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $F2img; ?>" alt="<?php echo $F2; ?>" title="<?php echo $F2; ?>"><label for="score46_r"><?php echo $F2; ?></label></td>
        ...
        <td class="date-venue">Match 24<br>Group F</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $F3img; ?>" alt="<?php echo $F3; ?>" title="<?php echo $F3; ?>"><label for="score47_r"><?php echo $F3; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $F1img; ?>" alt="<?php echo $F1; ?>" title="<?php echo $F1; ?>"><label for="score48_r"><?php echo $F1; ?></label></td>
        ...
        <td class="date-venue">Match 25<br>Group A</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $A4img; ?>" alt="<?php echo $A4; ?>" title="<?php echo $A4; ?>"><label for="score49_r"><?php echo $A4; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $A1img; ?>" alt="<?php echo $A1; ?>" title="<?php echo $A1; ?>"><label for="score50_r"><?php echo $A1; ?></label></td>
        ...
        <td class="date-venue">Match 26<br>Group A</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $A2img; ?>" alt="<?php echo $A2; ?>" title="<?php echo $A2; ?>"><label for="score51_r"><?php echo $A2; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $A3img; ?>" alt="<?php echo $A3; ?>" title="<?php echo $A3; ?>"><label for="score52_r"><?php echo $A3; ?></label></td>
	    ...
	    <td class="left-team">
        <img src="<?php echo "../" . $B2img; ?>" alt="<?php echo $B2; ?>" title="<?php echo $B2; ?>"><label for="score53_r"><?php echo $B2; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $B3img; ?>" alt="<?php echo $B3; ?>" title="<?php echo $B3; ?>"><label for="score54_r"><?php echo $B3; ?></label></td>
        ...
        <td class="date-venue">Match 28<br>Group B</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $B4img; ?>" alt="<?php echo $B4; ?>" title="<?php echo $B4; ?>"><label for="score55_r"><?php echo $B4; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $B1img; ?>" alt="<?php echo $B1; ?>" title="<?php echo $B1; ?>"><label for="score56_r"><?php echo $B1; ?></label></td>
        ...
        <td class="date-venue">Match 29<br>Group C</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $C2img; ?>" alt="<?php echo $C2; ?>" title="<?php echo $C2; ?>"><label for="score57_r"><?php echo $C2; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $C3img; ?>" alt="<?php echo $C3; ?>" title="<?php echo $C3; ?>"><label for="score58_r"><?php echo $C3; ?></label></td>
        ...
        <td class="date-venue">Match 30<br>Group C</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $C4img; ?>" alt="<?php echo $C4; ?>" title="<?php echo $C4; ?>"><label for="score59_r"><?php echo $C4; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $C1img; ?>" alt="<?php echo $C1; ?>" title="<?php echo $C1; ?>"><label for="score60_r"><?php echo $C1; ?></label></td>
	    ...
	    <td class="left-team">
        <img src="<?php echo "../" . $D2img; ?>" alt="<?php echo $D2; ?>" title="<?php echo $D2; ?>"><label for="score61_r"><?php echo $D2; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $D3img; ?>" alt="<?php echo $D3; ?>" title="<?php echo $D3; ?>"><label for="score62_r"><?php echo $D3; ?></label></td>
        ...
        <td class="date-venue">Match 32<br>Group D</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $D4img; ?>" alt="<?php echo $D4; ?>" title="<?php echo $D4; ?>"><label for="score63_r"><?php echo $D4; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $D1img; ?>" alt="<?php echo $D1; ?>" title="<?php echo $D1; ?>"><label for="score64_r"><?php echo $D1; ?></label></td>
        ...
        <td class="date-venue">Match 33<br>Group F</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $F4img; ?>" alt="<?php echo $F4; ?>" title="<?php echo $F4; ?>"><label for="score65_r"><?php echo $F4; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $F1img; ?>" alt="<?php echo $F1; ?>" title="<?php echo $F1; ?>"><label for="score66_r"><?php echo $F1; ?></label></td>
        ...
        <td class="date-venue">Match 34<br>Group F</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $F2img; ?>" alt="<?php echo $F2; ?>" title="<?php echo $F2; ?>"><label for="score67_r"><?php echo $F2; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $F3img; ?>" alt="<?php echo $F3; ?>" title="<?php echo $F3; ?>"><label for="score68_r"><?php echo $F3; ?></label></td>
	    ...
	    <td class="left-team">
        <img src="<?php echo "../" . $E2img; ?>" alt="<?php echo $E2; ?>" title="<?php echo $E2; ?>"><label for="score69_r"><?php echo $E2; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $E3img; ?>" alt="<?php echo $E3; ?>" title="<?php echo $E3; ?>"><label for="score70_r"><?php echo $E3; ?></label></td>
        ...
        <td class="date-venue">Match 36<br>Group E</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $E4img; ?>" alt="<?php echo $E4; ?>" title="<?php echo $E4; ?>"><label for="score71_r"><?php echo $E4; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $E1img; ?>" alt="<?php echo $E1; ?>" title="<?php echo $E1; ?>"><label for="score72_r"><?php echo $E1; ?></label></td>
        ...
        <td class="date-venue">Match 37<br>RO16</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $R1img; ?>" alt="<?php echo $R1; ?>" title="<?php echo $R1; ?>"><label for="score73_r"><?php echo $R1; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $R2img; ?>" alt="<?php echo $R2; ?>" title="<?php echo $R2; ?>"><label for="score74_r"><?php echo $R2; ?></label></td>
        ...
        <td class="date-venue">Match 38<br>RO16</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $R3img; ?>" alt="<?php echo $R3; ?>" title="<?php echo $R3; ?>"><label for="score75_r"><?php echo $R3; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $R4img; ?>" alt="<?php echo $R4; ?>" title="<?php echo $R4; ?>"><label for="score76_r"><?php echo $R4; ?></label></td>
        ...
        <td class="date-venue">Match 39<br>RO16</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $R5img; ?>" alt="<?php echo $R5; ?>" title="<?php echo $R5; ?>"><label for="score77_r"><?php echo $R5; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $R6img; ?>" alt="<?php echo $R6; ?>" title="<?php echo $R6; ?>"><label for="score78_r"><?php echo $R6; ?></label></td>
        ...
        <td class="date-venue">Match 40<br>RO16</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $R7img; ?>" alt="<?php echo $R7; ?>" title="<?php echo $R7; ?>"><label for="score79_r"><?php echo $R7; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $R8img; ?>" alt="<?php echo $R8; ?>" title="<?php echo $R8; ?>"><label for="score80_r"><?php echo $R8; ?></label></td>
        ...
        <td class="date-venue">Match 41<br>RO16</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $R9img; ?>" alt="<?php echo $R9; ?>" title="<?php echo $R9; ?>"><label for="score81_r"><?php echo $R9; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $R10img; ?>" alt="<?php echo $R10; ?>" title="<?php echo $R10; ?>"><label for="score82_r"><?php echo $R10; ?></label></td>
        ...
        <td class="date-venue">Match 42<br>RO16</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $R11img; ?>" alt="<?php echo $R11; ?>" title="<?php echo $R11; ?>"><label for="score83_r"><?php echo $R11; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $R12img; ?>" alt="<?php echo $R12; ?>" title="<?php echo $R12; ?>"><label for="score84_r"><?php echo $R12; ?></label></td>
        ...
        <td class="date-venue">Match 43<br>RO16</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $R13img; ?>" alt="<?php echo $R13; ?>" title="<?php echo $R13; ?>"><label for="score85_r"><?php echo $R13; ?></label></td>
      	...
      	<td class="right-team"><img src="<?php echo "../" . $R14img; ?>" alt="<?php echo $R14; ?>" title="<?php echo $R14; ?>"><label for="score86_r"><?php echo $R14; ?></label></td>
        ...
        <td class="date-venue">Match 44<br>RO16</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $R15img; ?>" alt="<?php echo $R15; ?>" title="<?php echo $R15; ?>"><label for="score87_r"><?php echo $R15; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $R16img; ?>" alt="<?php echo $R16; ?>" title="<?php echo $R16; ?>"><label for="score88_r"><?php echo $R16; ?></label></td>
        ...
        <td class="date-venue">Match 45<br>Quarter Final</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $Q1img; ?>" alt="<?php echo $Q1; ?>" title="<?php echo $Q1; ?>"><label for="score89_r"><?php echo $Q1; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $Q2img; ?>" alt="<?php echo $Q2; ?>" title="<?php echo $Q2; ?>"><label for="score90_r"><?php echo $Q2; ?></label></td>
        ...
        <td class="date-venue">Match 46<br>Quarter Final</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $Q3img; ?>" alt="<?php echo $Q3; ?>" title="<?php echo $Q3; ?>"><label for="score91_r"><?php echo $Q3; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $Q4img; ?>" alt="<?php echo $Q4; ?>" title="<?php echo $Q4; ?>"><label for="score92_r"><?php echo $Q4; ?></label></td>
        ...
        <td class="date-venue">Match 47<br>Quarter Final</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $Q5img; ?>" alt="<?php echo $Q5; ?>" title="<?php echo $Q5; ?>"><label for="score93_r"><?php echo $Q5; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $Q6img; ?>" alt="<?php echo $Q6; ?>" title="<?php echo $Q6; ?>"><label for="score94_r"><?php echo $Q6; ?></label></td>
        ...
        <td class="date-venue">Match 48<br>Quarter Final</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $Q7img; ?>" alt="<?php echo $Q7; ?>" title="<?php echo $Q7; ?>"><label for="score95_r"><?php echo $Q7; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $Q8img; ?>" alt="<?php echo $Q8; ?>" title="<?php echo $Q8; ?>"><label for="score96_r"><?php echo $Q8; ?></label></td>
        ...
        <td class="date-venue">Match 49<br>Semi Final</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $S1img; ?>" alt="<?php echo $S1; ?>" title="<?php echo $S1; ?>"><label for="score97_r"><?php echo $S1; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $S2img; ?>" alt="<?php echo $S2; ?>" title="<?php echo $S2; ?>"><label for="score98_r"><?php echo $S2; ?></label></td>
        ...
        <td class="date-venue">Match 50<br>Semi Final</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $S3img; ?>" alt="<?php echo $S3; ?>" title="<?php echo $S3; ?>"><label for="score99_r"><?php echo $S3; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $S4img; ?>" alt="<?php echo $S4; ?>" title="<?php echo $S4; ?>"><label for="score100_r"><?php echo $S4; ?></label></td>
        ...
        <td class="date-venue">Match 51<br>Final</td>        
      	<td class="left-team">
        <img src="<?php echo "../" . $Fi1img; ?>" alt="<?php echo $Fi1; ?>" title="<?php echo $Fi1; ?>"><label for="score101_r"><?php echo $Fi1; ?></label></td>
      	...
      	<td class="right-team">
        <img src="<?php echo "../" . $Fi2img; ?>" alt="<?php echo $Fi2; ?>" title="<?php echo $Fi2; ?>"><label for="score102_r"><?php echo $Fi2; ?></label></td>
