...
<html lang="en">
  <head>
    ...
    <title>Hendy's Hunches: ABOOT</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top col-md-12 visible-xs hidden-lg hidden-md">
      ...
      <p>A special mention of thanks to my very supportive (and increasingly pregnant) wife EJ whose patience has been much appreciated in the hours of our time I've dedicated to this project!</p>
      <div class="row">
      ...
      <div class="col-sm-12 col-md-4">
        <div class="thumbnail">
          ...
          <div class="caption">
            ...
            <p><strong>Winner:</strong> TBC</p>
            <p><strong>Runner-Up:</strong> TBC</p>
            <p><strong>Third Place:</strong> TBC</p>
            <p><strong>Last Place:</strong> TBC </p>
          </div>
        </div>
      </div>      
