...
<main id="main" class="main">
    ...
    <section class="section about-page">
		...
		<div class="row g-4 about-grid">
			...
			<div class="col-12 col-md-6 col-lg-4">
				<div class="card about-card h-100">
					<img src="img/wc2026-logo.png" alt="FIFA World Cup 2026 Game Image" class="card-img-top">
					<div class="card-body">
						<span class="about-season">FIFA World Cup 2026</span>
						<h5 class="card-title">The next showdown</h5>
						<p class="card-text">Predictions are still being lined up. Keep an eye out as the next chapter takes shape.</p>
					</div>
					<ul class="about-podium list-unstyled">
