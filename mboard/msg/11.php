...
<!--<hr>-->
<p align="center"><b>Re: Has anyone ever had 4 perfect results in a row before James?</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=11&up=9"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by James Henderson   on Sat 16th June 22:07 in reply to <a href="9.php">Has anyone ever had 4 perfect results in a row before James?</a> posted by Jonathan Lamley on Sat 16th June 22:03<br><font class="ip">80.7.57.36</font></p>

<p><b>Message</b>:</p>

<p>I'm equally astonished. I don't want to take anything away from Sonia's predicting genius but I can't recall anyone having 3 perfect results in a row let alone 4! <br><br>Fantastic Sonia - you've set a high bar for us all to catch now. Congrats :-)</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: Has anyone ever had 4 perfect results in a row before James?" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="11">
<input type="hidden" name="orig_name" value="James Henderson">
<input type="hidden" name="orig_subject" value="Re: Has anyone ever had 4 perfect results in a row before James?">
<input type="hidden" name="orig_date" value="Sat 16th June 22:07"><br>
<!--
