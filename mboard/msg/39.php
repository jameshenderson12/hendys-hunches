...
<!--<hr>-->
<p align="center"><b>Re: Re: My scores seem to have been wiped?</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=39&up=37"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by James Henderson   on Sat 14th July 23:30 in reply to <a href="37.php">Re: My scores seem to have been wiped?</a> posted by Dawn Kilbourn on Sat 14th July 23:21<br><font class="ip">80.7.57.36</font></p>

<p><b>Message</b>:</p>

<p>Dawn - I'll investigate and update this particular result accordingly assuming I can spot this from the various snapshots I have.<br><br>Again, apologies that this has happened unexpectedly.</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: Re: My scores seem to have been wiped?" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="39">
<input type="hidden" name="orig_name" value="James Henderson">
<input type="hidden" name="orig_subject" value="Re: Re: My scores seem to have been wiped?">
<input type="hidden" name="orig_date" value="Sat 14th July 23:30"><br>
<!--
