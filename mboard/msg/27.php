...
<!--<hr>-->
<p align="center"><b>Re: Updates</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=27&up=26"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by James Henderson   on Sun 1st July 10:13 in reply to <a href="26.php">Updates</a> posted by Sonia Fernandez on Sun 1st July 8:11<br><font class="ip">80.7.57.36</font></p>

<p><b>Message</b>:</p>

<p>That would be me Sonia. I have to manually update them after each game. Apologies, I was at a presentation night for my football team last night and so didn't get the chance! Updated now though.</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: Updates" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="27">
<input type="hidden" name="orig_name" value="James Henderson">
<input type="hidden" name="orig_subject" value="Re: Updates">
<input type="hidden" name="orig_date" value="Sun 1st July 10:13"><br>
<!--
