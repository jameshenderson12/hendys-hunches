...
<!--<hr>-->
<p align="center"><b>Well thats it for another tournament.</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=46&up=0"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Howard Kilbourn   on Mon 16th July 23:43 <br><font class="ip">81.109.89.17</font></p>

<p><b>Message</b>:</p>

<p>Hi James, well what a month that has been! thank you for all the work that you and others who helped put it all together. Massive thanks, it was great fun and brilliant to be part of once again.  Euros next! lol</p>
...
<ul>
<!-- zacni -->
<!--s 49--><li><a href="49.php">Re: Well thats it for another tournament.</a> - <b>James Henderson</b> <i>Wed 18th July 9:36</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Well thats it for another tournament." size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="46">
<input type="hidden" name="orig_name" value="Howard Kilbourn">
<input type="hidden" name="orig_subject" value="Well thats it for another tournament.">
<input type="hidden" name="orig_date" value="Mon 16th July 23:43"><br>
<!--
