...
<!--<hr>-->
<p align="center"><b>Re: Football genius</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=10&up=6"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by James Henderson   on Sat 16th June 22:06 in reply to <a href="6.php">Football genius</a> posted by David Clifton on Sat 16th June 19:12<br><font class="ip">80.7.57.36</font></p>

<p><b>Message</b>:</p>

<p>Agree completely! What an effort Sonia. Showing us all how it can be done! :-)</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: Football genius" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="10">
<input type="hidden" name="orig_name" value="James Henderson">
<input type="hidden" name="orig_subject" value="Re: Football genius">
<input type="hidden" name="orig_date" value="Sat 16th June 22:06"><br>
<!--
