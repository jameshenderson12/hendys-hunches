...
<!--<hr>-->
<p align="center"><b>Has anyone ever had 4 perfect results in a row before James?</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=9&up=0"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Jonathan Lamley   on Sat 16th June 22:03 <br><font class="ip">82.1.200.83</font></p>
...
<ul>
<!-- zacni -->
<!--s 13--><li><a href="13.php">Re: Has anyone ever had 4 perfect results in a row before James?</a> - <b>Neil Buxton</b> <i>Tue 19th June 11:07</i></li>
<!--s 12--><li><a href="12.php">Re: Has anyone ever had 4 perfect results in a row before James?</a> - <b>Simon Riley</b> <i>Mon 18th June 9:44</i></li>
<!--s 11--><li><a href="11.php">Re: Has anyone ever had 4 perfect results in a row before James?</a> - <b>James Henderson</b> <i>Sat 16th June 22:07</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Has anyone ever had 4 perfect results in a row before James?" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="9">
<input type="hidden" name="orig_name" value="Jonathan Lamley">
<input type="hidden" name="orig_subject" value="Has anyone ever had 4 perfect results in a row before James?">
<input type="hidden" name="orig_date" value="Sat 16th June 22:03"><br>
<!--
