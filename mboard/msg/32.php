...
<!--<hr>-->
<p align="center"><b>CALM</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=32&up=0"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Alan Williams   on Sat 7th July 15:52 <br><font class="ip">82.4.59.196</font></p>

<p><b>Message</b>:</p>

<p>Saw a few cyclistsat Derby Uni on Friday morning doing a cycle for CALM - 400 miles to Stirling in four days <a href="http://www.leedsbeckett.ac.uk/news/sport/leeds-beckett-american-football-coaches-to-cycle-400-miles-for-calm-charity/" target="_blank" rel="nofollow">http://www.leedsbeckett.ac.uk/news/sport/leeds-beckett-american-football-coaches-to-cycle-400-miles-for-calm-charity/</a></p>
...
<ul>
<!-- zacni -->
<!--s 33--><li><a href="33.php">Re: CALM</a> - <b>James Henderson</b> <i>Sat 7th July 21:39</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: CALM" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="32">
<input type="hidden" name="orig_name" value="Alan Williams">
<input type="hidden" name="orig_subject" value="CALM">
<input type="hidden" name="orig_date" value="Sat 7th July 15:52"><br>
<!--
