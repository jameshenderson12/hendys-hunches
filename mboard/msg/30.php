...
<!--<hr>-->
<p align="center"><b>Re: YESSSSSSSSSSS!!!!</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=30&up=29"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by James Henderson   on Fri 6th July 17:30 in reply to <a href="29.php">YESSSSSSSSSSS!!!!</a> posted by Jess Beaver on Tue 3rd July 21:56<br><font class="ip">128.243.175.34</font></p>

<p><b>Message</b>:</p>

<p>As a Scotsman, I'm not biting! :-)<br><br>But, it is looking a little brighter for England now that's for sure!</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: YESSSSSSSSSSS!!!!" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="30">
<input type="hidden" name="orig_name" value="James Henderson">
<input type="hidden" name="orig_subject" value="Re: YESSSSSSSSSSS!!!!">
<input type="hidden" name="orig_date" value="Fri 6th July 17:30"><br>
<!--
