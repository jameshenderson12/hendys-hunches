...
<!--<hr>-->
<p align="center"><b>Re: World Cup of Underdogs?</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=15&up=14"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by James Henderson   on Tue 19th June 21:55 in reply to <a href="14.php">World Cup of Underdogs?</a> posted by Andrew Lough on Tue 19th June 14:53<br><font class="ip">80.7.57.36</font></p>

<p><b>Message</b>:</p>

<p>Ha ha!! That's possibly a good shout Andrew. I think this World Cup has not done throwing surprises yet and I think we could have an interesting set of quarter finals on our hands!</p>
...
<ul>
<!-- zacni -->
<!--s 16--><li><a href="16.php">Re: Re: World Cup of Underdogs?</a> - <b>Jonathan Lamley</b> <i>Tue 19th June 22:46</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: World Cup of Underdogs?" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="15">
<input type="hidden" name="orig_name" value="James Henderson">
<input type="hidden" name="orig_subject" value="Re: World Cup of Underdogs?">
<input type="hidden" name="orig_date" value="Tue 19th June 21:55"><br>
<!--
