...
<!--<hr>-->
<p align="center"><b>Re: Re: World Cup of Underdogs?</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=16&up=15"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Jonathan Lamley   on Tue 19th June 22:46 in reply to <a href="15.php">Re: World Cup of Underdogs?</a> posted by James Henderson on Tue 19th June 21:55<br><font class="ip">82.1.200.83</font></p>

<p><b>Message</b>:</p>

<p>I just want some normality otherwise I'm going to end up being last!</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: Re: World Cup of Underdogs?" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="16">
<input type="hidden" name="orig_name" value="Jonathan Lamley">
<input type="hidden" name="orig_subject" value="Re: Re: World Cup of Underdogs?">
<input type="hidden" name="orig_date" value="Tue 19th June 22:46"><br>
<!--
