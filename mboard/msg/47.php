...
<!--<hr>-->
<p align="center"><b>Final places</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=47&up=0"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Neil Buxton   on Tue 17th July 11:41 <br><font class="ip">128.243.2.47</font></p>

<p><b>Message</b>:</p>

<p>James, <br>Sort out the standings for next time ;).<br>Danny came 4th, not third. I'd be gutted if i came joint second and got less prize money than a forth placed finisher. However... I didn't. :)</p>
...
<ul>
<!-- zacni -->
<!--s 50--><li><a href="50.php">Re: Final places</a> - <b>James Henderson</b> <i>Wed 18th July 9:39</i></li>
<!--s 48--><li><a href="48.php">Re: Final places</a> - <b>Neil Buxton</b> <i>Tue 17th July 11:53</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Final places" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="47">
<input type="hidden" name="orig_name" value="Neil Buxton">
<input type="hidden" name="orig_subject" value="Final places">
<input type="hidden" name="orig_date" value="Tue 17th July 11:41"><br>
<!--
