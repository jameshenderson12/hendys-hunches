...
<!--<hr>-->
<p align="center"><b>Re: Re: Re: Final places</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=52&up=51"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by James Henderson   on Thu 19th July 13:43 in reply to <a href="51.php">Re: Re: Final places</a> posted by Nick Chandler on Wed 18th July 18:10<br><font class="ip">128.243.175.34</font></p>

<p><b>Message</b>:</p>

<p>Thanks for the suggestions Nick, that's great. I'll definitely consider these for next time hopefully if I get it up and running again for the Euros!<br><br>On a separate note, please can you let me know how I can get your winnings to you? I've emailed you on your AOL account but not had a response. I'm happy to do a bank transfer so feel free to drop me an email at <a href="mailto&#58;james.henderson&#64;nottingham.ac.uk" rel="nofollow">james.henderson&#64;nottingham.ac.uk</a>.<br><br>Cheers,<br>James</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: Re: Re: Final places" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="52">
<input type="hidden" name="orig_name" value="James Henderson">
<input type="hidden" name="orig_subject" value="Re: Re: Re: Final places">
<input type="hidden" name="orig_date" value="Thu 19th July 13:43"><br>
<!--
