...
<!--<hr>-->
<p align="center"><b>Re: Final places</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=50&up=47"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by James Henderson   on Wed 18th July 9:39 in reply to <a href="47.php">Final places</a> posted by Neil Buxton on Tue 17th July 11:41<br><font class="ip">128.243.175.34</font></p>

<p><b>Message</b>:</p>

<p>Ha ha, fair point. I'm happy to take a suggestion as how to improve this? Yes, Danny was a bit fortunate but that's the way the prizes were allocated this time! :-)</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: Final places" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="50">
<input type="hidden" name="orig_name" value="James Henderson">
<input type="hidden" name="orig_subject" value="Re: Final places">
<input type="hidden" name="orig_date" value="Wed 18th July 9:39"><br>
<!--
