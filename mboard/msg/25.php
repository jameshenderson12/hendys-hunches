...
<!--<hr>-->
<p align="center"><b>Re: Extra time</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=25&up=24"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Jax Gallagher   on Sat 30th June 18:51 in reply to <a href="24.php">Extra time</a> posted by Courtney Lightfoot on Sat 30th June 15:51<br><font class="ip">86.4.32.15</font></p>

<p><b>Message</b>:</p>

<p>I believe it’s the normal 90 + added time eg 3/4/5mins. Penalties are not included.</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: Extra time" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="25">
<input type="hidden" name="orig_name" value="Jax Gallagher">
<input type="hidden" name="orig_subject" value="Re: Extra time">
<input type="hidden" name="orig_date" value="Sat 30th June 18:51"><br>
<!--
