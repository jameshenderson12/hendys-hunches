...
<!--<hr>-->
<p align="center"><b>Re: Re: Final places</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=51&up=48"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Nick Chandler   on Wed 18th July 18:10 in reply to <a href="48.php">Re: Final places</a> posted by Neil Buxton on Tue 17th July 11:53<br><font class="ip">141.105.204.223</font></p>

<p><b>Message</b>:</p>

<p>A great competition overall, mind you I am bound to say that, (thanks to my boy for inviting me)<br>Maybe next time it would be fairer to have a count back system in the case of tied positions, amount of correct scores or results to decide places. In the case of a tie then as this year, add the second and third place prize money and split it evenly then pay next position as fourth, just a couple of ideas.<br>Anyway thanks for the fun competition, I think my non English bias helped for a few of the draws that most of you predicted as wins, heart over head. Thanks again.</p>
...
<ul>
<!-- zacni -->
<!--s 52--><li><a href="52.php">Re: Re: Re: Final places</a> - <b>James Henderson</b> <i>Thu 19th July 13:43</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: Re: Final places" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="51">
<input type="hidden" name="orig_name" value="Nick Chandler">
<input type="hidden" name="orig_subject" value="Re: Re: Final places">
<input type="hidden" name="orig_date" value="Wed 18th July 18:10"><br>
<!--
