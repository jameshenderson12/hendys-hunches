...
<!--<hr>-->
<p align="center"><b>Football genius</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=6&up=0"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by David Clifton   on Sat 16th June 19:12 <br><font class="ip">82.10.182.228</font></p>

<p><b>Message</b>:</p>

<p>Well done Sonia⚽️<br>But take it easy on them cigars</p>
...
<ul>
<!-- zacni -->
<!--s 10--><li><a href="10.php">Re: Football genius</a> - <b>James Henderson</b> <i>Sat 16th June 22:06</i></li>
<!--s 8--><li><a href="8.php">Re: Football genius</a> - <b>David Clifton</b> <i>Sat 16th June 21:32</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Football genius" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="6">
<input type="hidden" name="orig_name" value="David Clifton">
<input type="hidden" name="orig_subject" value="Football genius">
<input type="hidden" name="orig_date" value="Sat 16th June 19:12"><br>
<!--
