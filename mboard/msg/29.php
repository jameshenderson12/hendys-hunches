...
<!--<hr>-->
<p align="center"><b>YESSSSSSSSSSS!!!!</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=29&up=0"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Jess Beaver   on Tue 3rd July 21:56 <br><font class="ip">148.252.128.136</font></p>
...
<ul>
<!-- zacni -->
<!--s 30--><li><a href="30.php">Re: YESSSSSSSSSSS!!!!</a> - <b>James Henderson</b> <i>Fri 6th July 17:30</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: YESSSSSSSSSSS!!!!" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="29">
<input type="hidden" name="orig_name" value="Jess Beaver">
<input type="hidden" name="orig_subject" value="YESSSSSSSSSSS!!!!">
<input type="hidden" name="orig_date" value="Tue 3rd July 21:56"><br>
<!--
