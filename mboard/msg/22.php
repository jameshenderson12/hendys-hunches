...
<!--<hr>-->
<p align="center"><b>Definition of torn</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=22&up=0"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Jax Gallagher   on Sat 23rd June 22:09 <br><font class="ip">86.4.32.15</font></p>

<p><b>Message</b>:</p>

<p>Wanting Sweden to win but desperately needing 7 points so cheering Germany!!</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Definition of torn" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="22">
<input type="hidden" name="orig_name" value="Jax Gallagher">
<input type="hidden" name="orig_subject" value="Definition of torn">
<input type="hidden" name="orig_date" value="Sat 23rd June 22:09"><br>
<!--
