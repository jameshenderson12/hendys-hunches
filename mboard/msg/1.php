...
<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=1&up=0"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by James Henderson   on Wed 13th June 23:22 <br><font class="ip">80.7.57.36</font></p>

<p><b>Message</b>:</p>

<p>Hi Folks,<br><br>Welcome to Hendy's Hunches for the 2018 FIFA World Cup in Russia. I just wanted to take this opportunity to wish you all good luck with your predictions and hope you enjoy watching the games.<br><br>Best Wishes,<br>James</p>
...
<ul>
<!-- zacni -->
<!--s 5--><li><a href="5.php">Re: Welcome</a> - <b>Nick Whiting</b> <i>Fri 15th June 15:07</i></li>
<!--s 4--><li><a href="4.php">Re: Welcome</a> - <b>Simon Riley</b> <i>Fri 15th June 12:15</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Welcome" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="1">
<input type="hidden" name="orig_name" value="James Henderson">
<input type="hidden" name="orig_subject" value="Welcome">
<input type="hidden" name="orig_date" value="Wed 13th June 23:22"><br>
<!--
