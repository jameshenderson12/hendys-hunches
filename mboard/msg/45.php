...
<!--<hr>-->
<p align="center"><b>Re: And so it ends...</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=45&up=43"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Claire Henson   on Mon 16th July 11:03 in reply to <a href="43.php">And so it ends...</a> posted by James Henderson on Sun 15th July 21:11<br><font class="ip">128.243.2.47</font></p>

<p><b>Message</b>:</p>

<p>Thank you James, it was great fun!</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: And so it ends..." size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="45">
<input type="hidden" name="orig_name" value="Claire Henson">
<input type="hidden" name="orig_subject" value="Re: And so it ends...">
<input type="hidden" name="orig_date" value="Mon 16th July 11:03"><br>
<!--
