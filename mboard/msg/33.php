...
<!--<hr>-->
<p align="center"><b>Re: CALM</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=33&up=32"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by James Henderson   on Sat 7th July 21:39 in reply to <a href="32.php">CALM</a> posted by Alan Williams on Sat 7th July 15:52<br><font class="ip">80.7.57.36</font></p>

<p><b>Message</b>:</p>

<p>Great stuff Alan. Pleasing to see others doing their bit to support a very worthy charity! I must admit that when I read your forum post title 'CALM' I was expecting to see you pleading with people for peace and calm after that England result! :-)</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: CALM" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="33">
<input type="hidden" name="orig_name" value="James Henderson">
<input type="hidden" name="orig_subject" value="Re: CALM">
<input type="hidden" name="orig_date" value="Sat 7th July 21:39"><br>
<!--
