...
<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=42&up=0"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by James Henderson   on Sun 15th July 20:47 <br><font class="ip">80.7.57.36</font></p>

<p><b>Message</b>:</p>

<p>I'm sure you would like to join me in congratulating the 2018 prizes winners: Nick Chandler (1st), Snigdha Dutta and Sonia Fernandez (2nd), Daniel Waite (3rd), Paul Hendrick (4th) and Rebecca Reeves (5th).<br><br>Very well done to you all. :-)</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Congratulations!" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="42">
<input type="hidden" name="orig_name" value="James Henderson">
<input type="hidden" name="orig_subject" value="Congratulations!">
<input type="hidden" name="orig_date" value="Sun 15th July 20:47"><br>
<!--
