...
<!--<hr>-->
<p align="center"><b>Oh Brazil...</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=31&up=0"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by James Henderson   on Fri 6th July 21:07 <br><font class="ip">80.7.57.36</font></p>

<p><b>Message</b>:</p>

<p>Congratulations to Belgium on a great performance! Don't mind me as I have a quiet little sob whilst ripping up my sweepstake ticket for the men in yellow! :-(</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Oh Brazil..." size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="31">
<input type="hidden" name="orig_name" value="James Henderson">
<input type="hidden" name="orig_subject" value="Oh Brazil...">
<input type="hidden" name="orig_date" value="Fri 6th July 21:07"><br>
<!--
