...
<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=5&up=1"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Nick Whiting   on Fri 15th June 15:07 in reply to <a href="1.php">Welcome</a> posted by James Henderson on Wed 13th June 23:22<br><font class="ip">128.243.2.47</font></p>

<p><b>Message</b>:</p>

<p>Can't wait to win</p>
...
<input type="hidden" name="orig_id" value="5">
<input type="hidden" name="orig_name" value="Nick Whiting">
<input type="hidden" name="orig_subject" value="Re: Welcome">
<input type="hidden" name="orig_date" value="Fri 15th June 15:07"><br>
<!--
