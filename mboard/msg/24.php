...
<!--<hr>-->
<p align="center"><b>Extra time</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=24&up=0"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Courtney Lightfoot   on Sat 30th June 15:51 <br><font class="ip">82.132.222.2</font></p>

<p><b>Message</b>:</p>

<p>Are predictions for 90 mins only, or final score after extra time if needed</p>
...
<ul>
<!-- zacni -->
<!--s 28--><li><a href="28.php">Re: Extra time</a> - <b>James Henderson</b> <i>Sun 1st July 10:13</i></li>
<!--s 25--><li><a href="25.php">Re: Extra time</a> - <b>Jax Gallagher</b> <i>Sat 30th June 18:51</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Extra time" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="24">
<input type="hidden" name="orig_name" value="Courtney Lightfoot">
<input type="hidden" name="orig_subject" value="Extra time">
<input type="hidden" name="orig_date" value="Sat 30th June 15:51"><br>
<!--
