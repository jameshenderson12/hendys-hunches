...
<!--<hr>-->
<p align="center"><b>Re: he name is luka</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=21&up=20"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Claire Henson   on Fri 22nd June 9:44 in reply to <a href="20.php">he name is luka</a> posted by Micky Doyle on Thu 21st June 20:57<br><font class="ip">128.243.2.47</font></p>

<p><b>Message</b>:</p>

<p>That's a good shout based on last night. They were brilliant, despite Argentina being so poor.</p>
...
<ul>
<!-- zacni -->
<!--s 23--><li><a href="23.php">Re: Re: he name is luka</a> - <b>Micky Doyle</b> <i>Sun 24th June 15:14</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: he name is luka" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="21">
<input type="hidden" name="orig_name" value="Claire Henson">
<input type="hidden" name="orig_subject" value="Re: he name is luka">
<input type="hidden" name="orig_date" value="Fri 22nd June 9:44"><br>
<!--
