...
<!--<hr>-->
<p align="center"><b>Gesture of good will for the opener</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=2&up=0"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by James Henderson   on Thu 14th June 14:50 <br><font class="ip">128.243.175.34</font></p>

<p><b>Message</b>:</p>

<p>To allow for a few last minute signups, I have decided to allow the 'lock down' of the first prediction to be extended right up until kick-off. This will be the case for this game only and all subsequent predictions  will follow the rule of being 'locked down' 1 hour before the game kicks off.</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Gesture of good will for the opener" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="2">
<input type="hidden" name="orig_name" value="James Henderson">
<input type="hidden" name="orig_subject" value="Gesture of good will for the opener">
<input type="hidden" name="orig_date" value="Thu 14th June 14:50"><br>
<!--
