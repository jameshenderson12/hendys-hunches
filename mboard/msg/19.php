...
<!--<hr>-->
<p align="center"><b>Re: Re: Slightly off topic...</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=19&up=18"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Claire Henson   on Thu 21st June 14:28 in reply to <a href="18.php">Re: Slightly off topic...</a> posted by James Henderson on Wed 20th June 22:55<br><font class="ip">128.243.2.47</font></p>

<p><b>Message</b>:</p>

<p>Hopefully the reds will do better than I am in this predictor :)</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: Re: Slightly off topic..." size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="19">
<input type="hidden" name="orig_name" value="Claire Henson">
<input type="hidden" name="orig_subject" value="Re: Re: Slightly off topic...">
<input type="hidden" name="orig_date" value="Thu 21st June 14:28"><br>
<!--
