...
<!--<hr>-->
<p align="center"><b>Re: My scores seem to have been wiped?</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=37&up=36"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Dawn Kilbourn   on Sat 14th July 23:21 in reply to <a href="36.php">My scores seem to have been wiped?</a> posted by Jonathan Lamley on Sat 14th July 22:44<br><font class="ip">81.109.89.17</font></p>

<p><b>Message</b>:</p>

<p>Happened to one of our scores after Wednesdays England game.......it was there on the night after the game but looked in the next day and prediction had vanished...........</p>
...
<ul>
<!-- zacni -->
<!--s 40--><li><a href="40.php">Re: Re: My scores seem to have been wiped?</a> - <b>James Henderson</b> <i>Sat 14th July 23:53</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: My scores seem to have been wiped?" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="37">
<input type="hidden" name="orig_name" value="Dawn Kilbourn">
<input type="hidden" name="orig_subject" value="Re: My scores seem to have been wiped?">
<input type="hidden" name="orig_date" value="Sat 14th July 23:21"><br>
<!--
