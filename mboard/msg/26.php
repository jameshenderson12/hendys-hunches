...
<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=26&up=0"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Sonia Fernandez   on Sun 1st July 8:11 <br><font class="ip">90.197.242.133</font></p>

<p><b>Message</b>:</p>

<p>Who updates the scores? Should it be doing automatically or is it you James?</p>
...
<ul>
<!-- zacni -->
<!--s 27--><li><a href="27.php">Re: Updates</a> - <b>James Henderson</b> <i>Sun 1st July 10:13</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Updates" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="26">
<input type="hidden" name="orig_name" value="Sonia Fernandez">
<input type="hidden" name="orig_subject" value="Updates">
<input type="hidden" name="orig_date" value="Sun 1st July 8:11"><br>
<!--
