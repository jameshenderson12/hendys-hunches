...
<!--<hr>-->
<p align="center"><b>Re: Re: he name is luka</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=23&up=21"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Micky Doyle   on Sun 24th June 15:14 in reply to <a href="21.php">Re: he name is luka</a> posted by Claire Henson on Fri 22nd June 9:44<br><font class="ip">86.149.89.252</font></p>

<p><b>Message</b>:</p>

<p>thanks Claire early days a win a win</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: Re: he name is luka" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="23">
<input type="hidden" name="orig_name" value="Micky Doyle">
<input type="hidden" name="orig_subject" value="Re: Re: he name is luka">
<input type="hidden" name="orig_date" value="Sun 24th June 15:14"><br>
<!--
