...
<!--<hr>-->
<p align="center"><b>Re: Football</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=35&up=34"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Jonathan Lamley   on Wed 11th July 21:40 in reply to <a href="34.php">Football</a> posted by Neil Webster on Mon 9th July 8:53<br><font class="ip">82.1.200.83</font></p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: Football" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="35">
<input type="hidden" name="orig_name" value="Jonathan Lamley">
<input type="hidden" name="orig_subject" value="Re: Football">
<input type="hidden" name="orig_date" value="Wed 11th July 21:40"><br>
<!--
