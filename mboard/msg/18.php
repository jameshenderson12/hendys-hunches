...
<!--<hr>-->
<p align="center"><b>Re: Slightly off topic...</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=18&up=17"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by James Henderson   on Wed 20th June 22:55 in reply to <a href="17.php">Slightly off topic...</a> posted by Claire Henson on Wed 20th June 16:42<br><font class="ip">80.7.57.36</font></p>

<p><b>Message</b>:</p>

<p>Sounds great Claire! Hope you get a decent few opening fixtures to match your excitement! Call me optimistic, but I think it could be a serious shout for promotion this year!! :-)</p>
...
<ul>
<!-- zacni -->
<!--s 19--><li><a href="19.php">Re: Re: Slightly off topic...</a> - <b>Claire Henson</b> <i>Thu 21st June 14:28</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: Slightly off topic..." size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="18">
<input type="hidden" name="orig_name" value="James Henderson">
<input type="hidden" name="orig_subject" value="Re: Slightly off topic...">
<input type="hidden" name="orig_date" value="Wed 20th June 22:55"><br>
<!--
