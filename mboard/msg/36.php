...
<!--<hr>-->
<p align="center"><b>My scores seem to have been wiped?</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=36&up=0"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Jonathan Lamley   on Sat 14th July 22:44 <br><font class="ip">82.1.200.83</font></p>
...
<ul>
<!-- zacni -->
<!--s 38--><li><a href="38.php">Re: My scores seem to have been wiped?</a> - <b>James Henderson</b> <i>Sat 14th July 23:27</i></li>
<!--s 37--><li><a href="37.php">Re: My scores seem to have been wiped?</a> - <b>Dawn Kilbourn</b> <i>Sat 14th July 23:21</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: My scores seem to have been wiped?" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="36">
<input type="hidden" name="orig_name" value="Jonathan Lamley">
<input type="hidden" name="orig_subject" value="My scores seem to have been wiped?">
<input type="hidden" name="orig_date" value="Sat 14th July 22:44"><br>
<!--
