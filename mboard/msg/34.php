...
<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=34&up=0"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Neil Webster   on Mon 9th July 8:53 <br><font class="ip">62.232.83.98</font></p>

<p><b>Message</b>:</p>

<p>Is coming home<br><br>That is all</p>
...
<ul>
<!-- zacni -->
<!--s 35--><li><a href="35.php">Re: Football</a> - <b>Jonathan Lamley</b> <i>Wed 11th July 21:40</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Football" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="34">
<input type="hidden" name="orig_name" value="Neil Webster">
<input type="hidden" name="orig_subject" value="Football">
<input type="hidden" name="orig_date" value="Mon 9th July 8:53"><br>
<!--
