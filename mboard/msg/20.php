...
<!--<hr>-->
<p align="center"><b>he name is luka</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=20&up=0"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Micky Doyle   on Thu 21st June 20:57 <br><font class="ip">86.154.160.76</font></p>

<p><b>Message</b>:</p>

<p>Croatia for the cup</p>
...
<ul>
<!-- zacni -->
<!--s 21--><li><a href="21.php">Re: he name is luka</a> - <b>Claire Henson</b> <i>Fri 22nd June 9:44</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: he name is luka" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="20">
<input type="hidden" name="orig_name" value="Micky Doyle">
<input type="hidden" name="orig_subject" value="he name is luka">
<input type="hidden" name="orig_date" value="Thu 21st June 20:57"><br>
<!--
