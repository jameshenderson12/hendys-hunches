...
<!--<hr>-->
<p align="center"><b>World Cup of Underdogs?</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=14&up=0"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Andrew Lough   on Tue 19th June 14:53 <br><font class="ip">5.70.118.204</font></p>

<p><b>Message</b>:</p>

<p>I think I need to change my predictions in favour of the underdogs for each match! It certainly wouldn't do my current scoring rate any harm!</p>
...
<ul>
<!-- zacni -->
<!--s 15--><li><a href="15.php">Re: World Cup of Underdogs?</a> - <b>James Henderson</b> <i>Tue 19th June 21:55</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: World Cup of Underdogs?" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="14">
<input type="hidden" name="orig_name" value="Andrew Lough">
<input type="hidden" name="orig_subject" value="World Cup of Underdogs?">
<input type="hidden" name="orig_date" value="Tue 19th June 14:53"><br>
<!--
