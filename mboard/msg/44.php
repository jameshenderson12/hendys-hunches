...
<!--<hr>-->
<p align="center"><b>Thank you James</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=44&up=43"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Jonathan Lamley   on Mon 16th July 9:58 in reply to <a href="43.php">And so it ends...</a> posted by James Henderson on Sun 15th July 21:11<br><font class="ip">128.243.96.74</font></p>

<p><b>Message</b>:</p>

<p>Thanks for everything you have done James. It makes every game count for something. <br>And, for a change, you did pretty well :-)</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Thank you James" size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="44">
<input type="hidden" name="orig_name" value="Jonathan Lamley">
<input type="hidden" name="orig_subject" value="Thank you James">
<input type="hidden" name="orig_date" value="Mon 16th July 9:58"><br>
<!--
