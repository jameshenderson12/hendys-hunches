...
<!--<hr>-->
<p align="center"><b>Slightly off topic...</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=17&up=0"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by Claire Henson   on Wed 20th June 16:42 <br><font class="ip">128.243.2.47</font></p>

<p><b>Message</b>:</p>

<p>But Championship fixtures out tomorrow! My first season with a season ticket, so I'm slightly overexcited!</p>
...
<ul>
<!-- zacni -->
<!--s 18--><li><a href="18.php">Re: Slightly off topic...</a> - <b>James Henderson</b> <i>Wed 20th June 22:55</i></li>
</ul>
<!--<hr>--></td>
</tr></table>
<!--</center></div>-->
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Slightly off topic..." size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="17">
<input type="hidden" name="orig_name" value="Claire Henson">
<input type="hidden" name="orig_subject" value="Slightly off topic...">
<input type="hidden" name="orig_date" value="Wed 20th June 16:42"><br>
<!--
