...
<!--<hr>-->
<p align="center"><b>Re: Well thats it for another tournament.</b></p>

<p><a href="http://www.hendyshunches.co.uk/mboard/mboard.php?a=delete&num=49&up=46"><img
src="http://www.hendyshunches.co.uk/mboard/images/delete.gif" width="16" height="14" border="0" alt="Delete this post"></a>
Submitted by James Henderson   on Wed 18th July 9:36 in reply to <a href="46.php">Well thats it for another tournament.</a> posted by Howard Kilbourn on Mon 16th July 23:43<br><font class="ip">128.243.175.34</font></p>

<p><b>Message</b>:</p>

<p>Thanks Howard. Your support is always greatly appreciated! Hopefully Scotland can get to the Euros to make it a bit more exciting for me personally! :-)</p>
...
<b>Subject:</b><br><input type="text" name="subject" value="Re: Re: Well thats it for another tournament." size="35" width="100%" maxlength=100 class="form-control"><br>
<b>Message:</b><br><textarea cols="35" rows="3" width="100%" name="message" class="form-control" placeholder="Enter message"></textarea>
<input type="hidden" name="orig_id" value="49">
<input type="hidden" name="orig_name" value="James Henderson">
<input type="hidden" name="orig_subject" value="Re: Well thats it for another tournament.">
<input type="hidden" name="orig_date" value="Wed 18th July 9:36"><br>
<!--
