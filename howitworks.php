...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top col-md-12 visible-xs hidden-lg hidden-md">
      ...
      <p><strong>My Predictions: </strong> To make your predictions, enter a score value into each box below. You can change score values for a game up until 2 hours before its kick-off. After which, the scores are “locked down” and won’t be editable. Remember to hit the 'Update my predictions' button to save your scores. Any game that doesn’t have a prediction entered will have a default value of 0 – 0 as the prediction.</p>
      ...
      <h2>Scoring</h2>
      <p>For any match, you can be awarded either 0, 1, 2, 3 or 8 points.</p>
      <p>The different scenarios for points scoring are as follows:</p>
      <ol type="A">
      <li><strong>1 point</strong> is awarded if you correctly predict any match outcome of home win, away win or draw.</li>
      <li><strong>2 points</strong> are awarded if you correctly predict either the home or away score (goals).</li>
      ...
      <li><strong>8 points</strong> are awarded if you correctly predict both home and away scores. In this case, you should take a bow and light up a cigar!</li>
      </ol>
      ...
      <tr class="success"><td>1 - 0</td><td>1 - 0</td><td>Home win, both correct scores and identical result predicted</td><td>8</td></tr>
      <tr class="success"><td>1 - 2</td><td>1 - 2</td><td>Away win, both correct scores and identical result predicted</td><td>8</td></tr>
      <tr class="success"><td>1 - 1</td><td>1 - 1</td><td>Draw, both correct scores and identical result predicted</td><td>8</td></tr>                       
      ...
      <tr class="warning"><td>0 - 0</td><td>0 - 1</td><td>Home score predicted</td><td>2</td></tr>         
      <tr class="warning"><td>1 - 1</td><td>0 - 1</td><td>Away score predicted</td><td>2</td></tr>      
      <tr class="warning"><td>1 - 0</td><td>2 - 1</td><td>Home win predicted</td><td>1</td></tr>
      <tr class="warning"><td>0 - 3</td><td>1 - 2</td><td>Away win predicted</td><td>1</td></tr>         
      <tr class="warning"><td>3 - 3</td><td>1 - 1</td><td>Draw predicted</td><td>1</td></tr>      
